...
const LOCAL_ONLY_KEYS = ["active-theme-v1", "realty-tab-v1", "saving-tab-v1", "wedding-tab-v1", "naver-map-key"];
const cloud = {
...
const WEDDING_VENUES = [
  ...
  { name: "\uC2DC\uADF8\uB2C8\uC5D8 \uC11C\uC6B8", area: "\uC1A1\uD30C\uAD6C", type: "\uD638\uD154", meal: "16~25\uB9CC", fee: "900\uB9CC~", cap: "100~300\uBA85", note: "\uB86F\uB370\uD0C0\uC6CC 76~79\uCE35 \uC2DC\uD2F0\uBDF0 \xB7 \uBBF8\uC250\uB9B0 3\uC2A4\uD0C0 \uC170\uD504 \uBA54\uB274\uC758 \uD504\uB9AC\uBBF8\uC5C4 \uC2A4\uBAB0\uC6E8\uB529" },
  { name: "\uADF8\uB79C\uB4DC \uC6CC\uCEE4\uD790 \uC11C\uC6B8", area: "\uAD11\uC9C4\uAD6C", type: "\uD638\uD154", meal: "12~18\uB9CC", fee: "1,000~2,000\uB9CC", cap: "300~900\uBA85", note: "\uD55C\uAC15\xB7\uC544\uCC28\uC0B0 \uBDF0 + \uC57C\uC678 \uAC00\uB4E0\uC6E8\uB529\uC774 \uAC15\uC810\uC778 \uC804\uD1B5 \uBA85\uC18C" },
  ...
  { name: "\uB354\uB77C\uC6C0", area: "\uAC15\uB0A8\uAD6C", type: "\uD558\uC6B0\uC2A4", meal: "13.5~15\uB9CC", fee: "550\uB9CC", cap: "150~400\uBA85", note: "\uC5ED\uC0BC\uB3D9 \uB7ED\uC154\uB9AC \uD558\uC6B0\uC2A4\uC6E8\uB529 \uC6D0\uC870\uACA9 \u2014 \uAC00\uB4E0\xB7\uCC44\uD50C \uB4F1 \uB2E4\uC591\uD55C \uC5F0\uCD9C" },
  { name: "\uBE4C\uB77C\uB4DC\uC9C0\uB514 \uCCAD\uB2F4", area: "\uAC15\uB0A8\uAD6C", type: "\uD558\uC6B0\uC2A4", meal: "13\uB9CC \uB0B4\uC678", fee: "2,500\uB9CC \uB0B4\uC678", cap: "200~450\uBA85", note: "22m \uCE35\uACE0 \xB7 29m \uBC84\uC9C4\uB85C\uB4DC \xB7 \uD1B5\uC720\uB9AC \uCC44\uAD11 \u2014 \uC5F0\uC608\uC778 \uC608\uC2DD \uB2E4\uC218" },
...
const ALLOC_DEFAULT = { totalCash: 2e4, realty: 12e3, saving: 4e3, wedding: 3e3 };
...
function CheongyakTab({ mapKey }) {
  ...
  const points = filtered.map((i) => ({ lat: i.lat, lng: i.lng, title: i.name, desc: `${i.region} \xB7 ${wonShort(i.priceMin)}~${wonShort(i.priceMax)}` }));
...
function RealtyListTab({ mapKey }) {
  ...
  const points = filtered.map((i) => ({ lat: i.lat, lng: i.lng, title: i.complex, desc: `${i.dealType} ${i.area}\u33A1 \xB7 ${i.priceText || won(i.price)}${i.rent ? "/\uC6D4 " + won(i.rent) : ""}` }));
