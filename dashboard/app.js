...
function estimateFinancing({ dealType, price, rent = 0, hh }) {
  ...
  const assetsWon = (Number(s.assets) || 0) * 1e4;
  const P = LOAN_POLICY;
  ...
  if (dealType === "전세" || dealType === "월세") {
    ...
    const binding2 = ratioLoan > P.jeonse.cap ? "보증 한도" : "보증금 80%";
    ...
    return {
      ...
      gap: requiredCash2 - assetsWon,
      monthly,
      programs,
      loanLabel: dealType === "월세" ? "보증금 대출" : "전세대출",
      monthlyLabel: dealType === "월세" ? `월세 + 대출이자(${s.loanRateCalc}%)` : `월 이자(${s.loanRateCalc}%)`
    };
  }
...
function PillNav({ tabs, tab, setTab }) {
  ...
  return /* @__PURE__ */ React.createElement("nav", { className: "sticky top-0 z-10 bg-[#F4F4F5]/95 backdrop-blur -mx-5 sm:-mx-10 px-5 sm:px-10 py-3" }, /* @__PURE__ */ React.createElement("div", { ref: rowRef, className: "flex gap-1.5 overflow-x-auto no-scrollbar" }, tabs.map((t) => {
...
function CheongyakTab({ mapKey }) {
  ...
  const toggleIn = (setSel2) => (v) => setSel2((prev) => prev.includes(v) ? prev.filter((x) => x !== v) : [...prev, v]);
...
function FinancingBlock({ item, hh, privacy }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "mt-3 rounded-xl bg-[#FAFAFA] px-3 py-2.5 text-[12.5px] leading-relaxed space-y-0.5" }, /* @__PURE__ */ React.createElement("div", { className: "flex justify-between gap-2" }, /* @__PURE__ */ React.createElement("span", { className: "font-semibold" }, f.loanLabel, " 예상 ", /* @__PURE__ */ React.createElement("span", { className: "text-[#6B6B6B] font-normal" }, "· ", f.binding)), /* @__PURE__ */ React.createElement("b", { style: { fontVariantNumeric: "tabular-nums" } }, wonShort(f.maxLoan))), /* @__PURE__ */ React.createElement("div", { className: "flex justify-between gap-2 text-[#525252]" }, /* @__PURE__ */ React.createElement("span", null, "필요 자기자본"), /* @__PURE__ */ React.createElement("span", { style: { fontVariantNumeric: "tabular-nums" } }, wonShort(f.requiredCash), " ", /* @__PURE__ */ React.createElement(Blur, { on: privacy }, f.gap > 0 ? `· 부족 ${wonShort(f.gap)}` : "· 충족"))), /* @__PURE__ */ React.createElement("div", { className: "flex justify-between gap-2 text-[#525252]" }, /* @__PURE__ */ React.createElement("span", null, f.monthlyLabel), /* @__PURE__ */ React.createElement("span", { style: { fontVariantNumeric: "tabular-nums" } }, won(Math.round(f.monthly)))), /* @__PURE__ */ React.createElement("div", { className: ok.length ? "text-[#1F5D46]" : "text-[#6B6B6B]" }, ok.length ? `정책대출 가능: ${ok.map((p) => `${p.name}(한도 ${wonShort(p.limit)}, ${p.cond})`).join(" · ")}` : `정책대출 해당 없음 — ${f.programs[0] ? f.programs[0].reason : "규칙 없음"}`));
}
...
function EligibilityCheckTab() {
  ...
  const hhSizeIfPreg = Math.min(5, hhSize + 1);
...
function WeddingVendorTab({ kind, confirmed, onConfirm }) {
  ...
  return /* @__PURE__ */ React.createElement("section", { className: "mb-6" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-end justify-between gap-3 flex-wrap" }, /* @__PURE__ */ React.createElement(SectionHeader, { eyebrow: meta.at ? `${meta.at.slice(0, 10)} 실시간 리서치` : "시작 리스트 · 대표 업체 예시", title: def.label }), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 mb-4 flex-wrap" }, /* @__PURE__ */ React.createElement(TextInput, { value: area, onChange: setArea, placeholder: "지역·업체명 필터", className: "!w-36 !h-9 !bg-white shadow-sm" }), /* @__PURE__ */ React.createElement(
    ...
    isConf(v) ? "확정 해제" : "확정하기"
  )), /* @__PURE__ */ React.createElement(TextInput, { value: v.img || "", onChange: (val) => patchVendor(v.id, "img", val), placeholder: "대표 사진 URL 붙여넣기 (선택)", className: "!h-8 !text-[12px]" })))), /* @__PURE__ */ React.createElement(Card, { className: "h-full flex flex-col justify-center border-dashed" }, /* @__PURE__ */ React.createElement("div", { className: "text-[13px] font-semibold text-[#6B6B6B] mb-3" }, "직접 추가 — 박람회·후기에서 알게 된 업체를 기록해 부부가 함께 비교하세요"), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 gap-2 mb-2" }, /* @__PURE__ */ React.createElement(TextInput, { value: nv.name, onChange: (v) => setNv({ ...nv, name: v }), placeholder: "업체명 *" }), /* @__PURE__ */ React.createElement(TextInput, { value: nv.area, onChange: (v) => setNv({ ...nv, area: v }), placeholder: "지역 (예: 청담)" }), /* @__PURE__ */ React.createElement(TextInput, { value: nv.price, onChange: (v) => setNv({ ...nv, price: v }), placeholder: "가격대 (예: 180만~)" }), /* @__PURE__ */ React.createElement(TextInput, { value: nv.note, onChange: (v) => setNv({ ...nv, note: v }), placeholder: "메모" })), /* @__PURE__ */ React.createElement(
    "button",
    {
      onClick: () => {
...
function GuestSideCard({ title, list, nv, setNv, onAdd, onToggle, onRemove, onPatch, onMove, onReorder, relOptions = [] }) {
  ...
  return /* @__PURE__ */ React.createElement(Card, { className: "h-full" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between mb-3" }, /* @__PURE__ */ React.createElement("h4", { className: "text-[15px] font-bold" }, title), /* @__PURE__ */ React.createElement("span", { className: "font-mono text-[12px] font-semibold text-[#6B6B6B]" }, guestHeads(list), "명 · 청모 ", guestHeads(list.filter((g) => g.chungmo)), "명")), /* @__PURE__ */ React.createElement("div", { className: "flex gap-2 mb-3" }, /* @__PURE__ */ React.createElement(TextInput, { value: nv.name, onChange: (v) => setNv({ ...nv, name: v }), placeholder: "이름 *", className: "flex-1 min-w-0" }), /* @__PURE__ */ React.createElement(TextInput, { value: nv.rel, onChange: (v) => setNv({ ...nv, rel: v }), placeholder: "관계 (예: 친구·회사)", className: "flex-1 min-w-0", list: relDlId }), /* @__PURE__ */ React.createElement(NumInput, { value: nv.cnt, onChange: (v) => setNv({ ...nv, cnt: v }), className: "!w-[64px] shrink-0 text-center" }), /* @__PURE__ */ React.createElement("button", { onClick: onAdd, className: "h-10 px-4 rounded-lg bg-[#0A0A0A] text-white text-[13px] font-semibold shrink-0 flex items-center gap-1" }, /* @__PURE__ */ React.createElement(Icon, { name: "plus", size: 13 }), " 추가")), /* @__PURE__ */ React.createElement("datalist", { id: relDlId }, relOptions.map((r) => /* @__PURE__ */ React.createElement("option", { key: r, value: r }))), list.length > 1 && /* @__PURE__ */ React.createElement("div", { className: "flex gap-1 mb-2" }, GUEST_SORTS.map(([k, l]) => /* @__PURE__ */ React.createElement(
    ...
    "button",
    {
      ...
      title: "위로",
      disabled: idx === 0,
      className: "h-4 w-5 flex items-center justify-center text-[#B0B0B0] hover:text-[#0A0A0A] disabled:opacity-25 disabled:hover:text-[#B0B0B0]"
    },
...
function GuestListTab() {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("section", { className: "mb-6" }, /* @__PURE__ */ React.createElement(SectionHeader, { eyebrow: "Guest List", title: "하객 초대 리스트" }), /* @__PURE__ */ React.createElement(Card, { className: "!p-0 overflow-hidden mb-4" }, /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-4 divide-x divide-[#F0F0F0] text-center" }, /* @__PURE__ */ React.createElement("div", { className: "p-4" }, /* @__PURE__ */ React.createElement("div", { className: "text-[12px] text-[#6B6B6B] mb-1" }, "총 하객"), /* @__PURE__ */ React.createElement("div", { className: "text-lg font-bold", style: { fontVariantNumeric: "tabular-nums" } }, guestHeads(guests), "명"), /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-[#B0B0B0]" }, guests.length, "팀")), /* @__PURE__ */ React.createElement("div", { className: "p-4" }, /* @__PURE__ */ React.createElement("div", { className: "text-[12px] text-[#6B6B6B] mb-1" }, "신랑측"), /* @__PURE__ */ React.createElement("div", { className: "text-lg font-bold", style: { fontVariantNumeric: "tabular-nums" } }, guestHeads(bySide("h")), "명"), /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-[#B0B0B0]" }, bySide("h").length, "팀")), /* @__PURE__ */ React.createElement("div", { className: "p-4" }, /* @__PURE__ */ React.createElement("div", { className: "text-[12px] text-[#6B6B6B] mb-1" }, "신부측"), /* @__PURE__ */ React.createElement("div", { className: "text-lg font-bold", style: { fontVariantNumeric: "tabular-nums" } }, guestHeads(bySide("w")), "명"), /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-[#B0B0B0]" }, bySide("w").length, "팀")), /* @__PURE__ */ React.createElement("div", { className: "p-4" }, /* @__PURE__ */ React.createElement("div", { className: "text-[12px] text-[#6B6B6B] mb-1" }, "청모 참석"), /* @__PURE__ */ React.createElement("div", { className: "text-lg font-bold", style: { fontVariantNumeric: "tabular-nums" } }, guestHeads(guests.filter((g) => g.chungmo)), "명"), /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-[#B0B0B0]" }, guests.filter((g) => g.chungmo).length, "팀")))), /* @__PURE__ */ React.createElement("div", { className: "grid lg:grid-cols-2 gap-4 items-start" }, /* @__PURE__ */ React.createElement(
    GuestSideCard,
    {
      title: "🤵 신랑측",
      list: bySide("h"),
...
function WeddingBudgetTab({ budget, setBudget, alloc }) {
  ...
  const cats = Array.from(new Set(budget.map(budgetCat))).sort((a, b) => rank(a) - rank(b));
  ...
  return /* @__PURE__ */ React.createElement("section", { className: "mb-6" }, /* @__PURE__ */ React.createElement(SectionHeader, { eyebrow: "2025~26 결혼 준비 후기 기반", title: "예식 비용 예산표" }), /* @__PURE__ */ React.createElement(Card, { className: "mb-4" }, /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-3 gap-3 mb-3" }, [["예산", totalBudget], ["실제 지출", totalSpent], ["남은 예산", totalBudget - totalSpent]].map(([l, v]) => /* @__PURE__ */ React.createElement("div", { key: l }, /* @__PURE__ */ React.createElement("div", { className: "text-[12px] text-[#6B6B6B] mb-0.5" }, l), /* @__PURE__ */ React.createElement("div", { className: "text-[19px] font-bold tracking-tight", style: { fontVariantNumeric: "tabular-nums" } }, manWon(v))))), /* @__PURE__ */ React.createElement(ProgressBar, { ratio: totalBudget > 0 ? totalSpent / totalBudget : 0 }), /* @__PURE__ */ React.createElement("div", { className: "mt-2 flex justify-between text-[13px] text-[#6B6B6B]" }, /* @__PURE__ */ React.createElement("span", null, "집행률 ", /* @__PURE__ */ React.createElement("b", { className: "text-[#0A0A0A]" }, totalBudget > 0 ? Math.round(totalSpent / totalBudget * 100) : 0, "%"), " · 항목 ", budget.length, "개 · 지출 기록 ", budget.filter((b) => b.spent > 0).length, "개"), alloc.wedding > 0 && /* @__PURE__ */ React.createElement("span", null, "홈 배정 ", manWon(alloc.wedding), " 대비 ", Math.round(totalBudget / alloc.wedding * 100), "% ", totalBudget > alloc.wedding && /* @__PURE__ */ React.createElement("b", { className: "text-[#0A0A0A] underline underline-offset-2" }, "초과"))), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2 mt-4" }, cats.map((c) => {
    const l = budget.filter((b) => budgetCat(b) === c), bb = sum(l, "budget"), ss = sum(l, "spent");
    return /* @__PURE__ */ React.createElement(
      "button",
      {
        key: c,
      ...
      /* @__PURE__ */ React.createElement("div", { className: `text-[12px] truncate ${open[c] ? "text-white/60" : "text-[#6B6B6B]"}` }, c),
      /* @__PURE__ */ React.createElement("div", { className: "text-[13px] font-bold", style: { fontVariantNumeric: "tabular-nums" } }, manWon(ss), " ", /* @__PURE__ */ React.createElement("span", { className: `font-normal ${open[c] ? "text-white/60" : "text-[#6B6B6B]"}` }, "/ ", manWon(bb)))
    );
  }))), /* @__PURE__ */ React.createElement("div", { className: "flex justify-end gap-2 mb-3" }, /* @__PURE__ */ React.createElement("button", { onClick: () => setOnlyOpen(!onlyOpen), className: `h-8 px-3 rounded-full text-[12px] font-semibold ${onlyOpen ? "bg-[#0A0A0A] text-white" : "bg-white text-[#525252] shadow-sm"}` }, onlyOpen ? "지출 미기록만 보는 중" : "지출 미기록만 보기"), /* @__PURE__ */ React.createElement("button", { onClick: () => {
    ...
    return /* @__PURE__ */ React.createElement(Card, { key: c, id: `wb-${encodeURIComponent(c)}`, className: "!p-0 scroll-mt-20 overflow-hidden" }, /* @__PURE__ */ React.createElement("button", { onClick: () => setOpenCat(c, !open[c]), className: "w-full flex items-center gap-3 px-5 py-4 text-left hover:bg-[#FAFAFA]" }, /* @__PURE__ */ React.createElement(Icon, { name: "chevron", size: 16, className: `shrink-0 text-[#6B6B6B] transition-transform ${open[c] ? "rotate-90" : ""}` }), /* @__PURE__ */ React.createElement("h4", { className: "text-[15px] font-bold flex-1 min-w-0 truncate" }, c, " ", /* @__PURE__ */ React.createElement("span", { className: "font-normal text-[12px] text-[#6B6B6B] ml-1" }, all.length, "개")), /* @__PURE__ */ React.createElement("div", { className: "hidden sm:block w-32" }, /* @__PURE__ */ React.createElement(ProgressBar, { ratio: bb > 0 ? ss / bb : 0, height: 4 })), /* @__PURE__ */ React.createElement("span", { className: "font-mono text-[13px] shrink-0", style: { fontVariantNumeric: "tabular-nums" } }, /* @__PURE__ */ React.createElement("b", null, manWon(ss)), " ", /* @__PURE__ */ React.createElement("span", { className: "text-[#6B6B6B]" }, "/ ", manWon(bb)))), open[c] && /* @__PURE__ */ React.createElement("div", { className: "px-5 pb-4 border-t border-[#F0F0F0]" }, /* @__PURE__ */ React.createElement("div", { className: `${BUDGET_ROW} text-[11px] text-[#6B6B6B] py-2` }, /* @__PURE__ */ React.createElement("span", null, "항목"), /* @__PURE__ */ React.createElement("span", { className: "hidden sm:block" }, "메모"), /* @__PURE__ */ React.createElement("span", { className: "text-right" }, "예산(만)"), /* @__PURE__ */ React.createElement("span", { className: "text-right" }, "지출(만)"), /* @__PURE__ */ React.createElement("span", null)), /* @__PURE__ */ React.createElement("div", { className: "divide-y divide-[#F4F4F4]" }, list.map((b) => /* @__PURE__ */ React.createElement("div", { key: b.id, className: `${BUDGET_ROW} py-1.5 items-center` }, /* @__PURE__ */ React.createElement(TextInput, { ariaLabel: "항목명", value: b.name, onChange: (v) => patch(b.id, "name", v), className: "!h-9 font-semibold" }), /* @__PURE__ */ React.createElement("div", { className: "col-span-4 sm:col-span-1 order-last sm:order-none min-w-0" }, b.linkLabel && /* @__PURE__ */ React.createElement("div", { className: "text-[11px] font-semibold text-[#0A0A0A] px-1 truncate", title: b.linkLabel }, "🔗 ", b.linkLabel), /* @__PURE__ */ React.createElement(TextInput, { value: b.note || "", onChange: (v) => patch(b.id, "note", v), placeholder: "메모 (업체·결제일·조건)", className: "!h-7 !text-[12px] !bg-transparent !px-1 text-[#6B6B6B]" })), /* @__PURE__ */ React.createElement(NumInput, { ariaLabel: `${b.name} 예산(만원)`, value: b.budget, onChange: (v) => patch(b.id, "budget", v), className: "!h-9 !px-2 !text-[13px] text-right" }), /* @__PURE__ */ React.createElement(NumInput, { ariaLabel: `${b.name} 지출(만원)`, value: b.spent, onChange: (v) => patch(b.id, "spent", v), className: `!h-9 !px-2 !text-[13px] text-right ${b.spent > b.budget && b.budget > 0 ? "!text-[#C0392B]" : ""}` }), /* @__PURE__ */ React.createElement(IconBtn, { name: "trash", title: "항목 삭제", onClick: () => setBudget(budget.filter((x) => x.id !== b.id)), className: "!w-8 !h-9" }))), onlyOpen && list.length === 0 && /* @__PURE__ */ React.createElement("div", { className: "text-[12px] text-[#B0B0B0] py-2" }, "모두 지출을 기록했어요")), /* @__PURE__ */ React.createElement("div", { className: "flex gap-1.5 mt-3" }, /* @__PURE__ */ React.createElement(
      TextInput,
      {
        value: n.name,
        onChange: (v) => setNewItem({ ...newItem, [c]: { ...n, name: v } }),
        placeholder: `${c}에 항목 추가`,
        className: "flex-1 min-w-0 !h-9",
        onKeyDown: (e) => {
          if (e.key === "Enter") addItem(c);
        }
      }
    ), /* @__PURE__ */ React.createElement(NumInput, { value: n.budget, onChange: (v) => setNewItem({ ...newItem, [c]: { ...n, budget: v } }), className: "!w-[5.5rem] !h-9 !px-2" }), /* @__PURE__ */ React.createElement("button", { onClick: () => addItem(c), className: "h-9 px-3 rounded-lg bg-[#0A0A0A] text-white font-semibold text-[13px] shrink-0" }, "추가"))));
...
function WeddingTheme({ hh, privacy }) {
  ...
  const venues = venueList.filter((v) => (venueFilter === "all" || v.type === venueFilter) && (!vSearch.area.trim() || `${v.area || ""} ${v.name || ""}`.includes(vSearch.area.trim())) && (!(vSearch.maxMeal > 0) || mealMinOf(v) === null || mealMinOf(v) <= vSearch.maxMeal)).sort((a, b) => (isConfVenue(b) ? 1 : 0) - (isConfVenue(a) ? 1 : 0));
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(PhaseGauge, { themeId: "wedding" }), /* @__PURE__ */ React.createElement(PillNav, { tabs: WEDDING_TABS, tab, setTab }), tab === "overview" && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("section", { className: "mb-6" }, /* @__PURE__ */ React.createElement("div", { onClick: burst, className: "relative overflow-hidden rounded-3xl bg-[#0A0A0A] text-white px-6 py-12 text-center cursor-pointer select-none", title: "클릭해 보세요 🤍" }, /* @__PURE__ */ React.createElement(HeartField, null), bursts.map((p) => /* @__PURE__ */ React.createElement("span", { key: p.id, className: "heart-b text-white/80", style: { "--x": p.x, "--y": p.y } }, /* @__PURE__ */ React.createElement(Icon, { name: "heart", size: p.s, fill: "currentColor" }))), /* @__PURE__ */ React.createElement("div", { className: "relative font-mono text-[11px] font-medium tracking-[0.26em] uppercase text-white/45 mb-3" }, "Our Wedding Day"), /* @__PURE__ */ React.createElement("div", { className: "relative font-mono text-[56px] sm:text-[72px] leading-none font-semibold tracking-tight" }, d === null ? "D - ?" : ddayText(d)), /* @__PURE__ */ React.createElement("div", { className: "relative mt-4 text-[14px] text-white/60" }, info.date ? `${info.date}${info.venue ? " · " + info.venue : ""}` : "아래에서 예식일을 설정해 주세요")), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-3 mt-3" }, /* @__PURE__ */ React.createElement(Kpi, { icon: "check2", label: "체크리스트 진행", value: `${taskDone}/${taskTotal}` }), /* @__PURE__ */ React.createElement(Kpi, { icon: "piggy", label: "예산 집행률", value: `${Math.round(totalSpent / Math.max(1, totalBudget) * 100)}%`, accent: "#525252" }), /* @__PURE__ */ React.createElement(Kpi, { icon: "users", label: "하객 리스트", value: `${guestHeads(guestsAll)}명`, accent: "#8A8A8A" }), /* @__PURE__ */ React.createElement(Kpi, { icon: "building", label: "식장 후보", value: `${venueList.length}곳`, accent: "#B0B0B0" })), /* @__PURE__ */ React.createElement(Card, { className: "mt-3 !p-4" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between mb-3" }, /* @__PURE__ */ React.createElement("div", { className: "text-[13px] font-semibold text-[#6B6B6B]" }, "확정한 업체"), /* @__PURE__ */ React.createElement("button", { onClick: () => setTab("vendors"), className: "text-[12px] font-semibold text-[#525252] underline underline-offset-4" }, "후보 비교하러 가기")), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 lg:grid-cols-5 gap-2" }, [["venue", "🏛", "식장"], ["studio", "📸", "스튜디오"], ["dress", "👗", "드레스"], ["makeup", "💄", "메이크업"], ["snap", "🎞", "스냅"]].map(([k, ic, label]) => {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { className: `text-[13px] font-bold truncate ${c ? "" : "text-[#B0B0B0]"}` }, c ? c.name : "미정 — 비교하기"),
  ...
  })(), tab === "vendors" && /* @__PURE__ */ React.createElement("div", { className: "mb-5 flex items-center gap-1.5 flex-wrap" }, [["venue", "🏛 식장"], ["studio", "📸 스튜디오"], ["dress", "👗 드레스"], ["makeup", "💄 메이크업"], ["snap", "🎞 스냅"]].map(([id, label]) => /* @__PURE__ */ React.createElement(
    "button",
    {
      key: id,
      onClick: () => setSeg(id),
  ...
  ))), /* @__PURE__ */ React.createElement(Card, { className: "mb-4" }, /* @__PURE__ */ React.createElement("div", { className: "text-[13px] font-semibold text-[#6B6B6B] mb-3" }, "원하는 조건으로 검색 — 테마(유형)는 위 필터로, 위치·가격대는 아래에 입력하면 리스트가 바로 좁혀져요"), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-3 items-end" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "text-[12px] text-[#6B6B6B] block mb-1" }, "위치 (지역·식장명)"), /* @__PURE__ */ React.createElement(TextInput, { value: vSearch.area, onChange: (v) => setVSearch({ ...vSearch, area: v }), placeholder: "예: 강남구, 반포" })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "text-[12px] text-[#6B6B6B] block mb-1" }, "1인 식대 상한(만원, 0=무제한)"), /* @__PURE__ */ React.createElement(NumInput, { value: vSearch.maxMeal, onChange: (v) => setVSearch({ ...vSearch, maxMeal: v }) })), /* @__PURE__ */ React.createElement(
    "a",
    {
...
function Roadmap() {
  ...
  const addPhase = () => {
    ...
    setTimeout(() => {
      const el = scrollRef.current;
      if (el) {
        el.scrollTo({ left: visible.length * el.clientWidth, behavior: "smooth" });
...
function HomeTheme({ setTheme, hh, setHh, privacy }) {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Roadmap, null), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-5" }, /* @__PURE__ */ React.createElement(Kpi, { icon: "piggy", label: "총 현금 자산", value: /* @__PURE__ */ React.createElement(Blur, { on: privacy }, manWon(alloc.totalCash)), accent: "#0A0A0A" }), /* @__PURE__ */ React.createElement(Kpi, { icon: "calc", label: over ? "배분 초과" : "남은 여유자금", value: /* @__PURE__ */ React.createElement(Blur, { on: privacy }, over ? /* @__PURE__ */ React.createElement(React.Fragment, null, "-", manWon(-free)) : manWon(free)), accent: "#4B4B4B" }), /* @__PURE__ */ React.createElement(Kpi, { icon: "heart", label: "결혼식 D-Day", value: wedding.d === null ? "미정" : ddayText(wedding.d), accent: "#8A8A8A" }), /* @__PURE__ */ React.createElement(Kpi, { icon: "trending", label: "절세계좌 잔액", value: /* @__PURE__ */ React.createElement(Blur, { on: privacy }, manWon(saving.totalBalance)), accent: "#C6C6C6" })), /* @__PURE__ */ React.createElement("section", null, /* @__PURE__ */ React.createElement(SectionHeader, { eyebrow: "Couple Profile", title: "우리 부부 정보" }), /* @__PURE__ */ React.createElement(Card, { className: privacy ? "privacy-on" : "" }, /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 lg:grid-cols-5 gap-4" }, /* @__PURE__ */ React.createElement(Field, { label: `${hh.label1 || "본인"} 연소득(만원)`, value: hh.income1, onChange: (v) => setHh({ income1: v }) }), /* @__PURE__ */ React.createElement(Field, { label: `${hh.label2 || "배우자"} 연소득(만원)`, value: hh.income2, onChange: (v) => setHh({ income2: v }) }), /* @__PURE__ */ React.createElement(Field, { label: "현재 순자산(만원)", value: hh.assets, onChange: (v) => setHh({ assets: v }) }), /* @__PURE__ */ React.createElement(Field, { label: "월 저축가능액(만원)", value: hh.monthlySave, onChange: (v) => setHh({ monthlySave: v }) }), /* @__PURE__ */ React.createElement(Field, { label: "기존 대출 월상환(만원)", value: hh.existingDebtMonthly, onChange: (v) => setHh({ existingDebtMonthly: v }) })), /* @__PURE__ */ React.createElement("div", { className: "mt-4 pt-4 border-t border-[#F0F0F0] flex flex-wrap items-center gap-x-8 gap-y-2" }, /* @__PURE__ */ React.createElement("span", { className: "text-[14px] text-[#6B6B6B]" }, "부부합산 월소득(세전) ", /* @__PURE__ */ React.createElement("b", { className: "text-[#0A0A0A]", style: { fontVariantNumeric: "tabular-nums" } }, /* @__PURE__ */ React.createElement(Blur, { on: privacy }, won(Math.round((hh.income1 + hh.income2) * 1e4 / 12))))), /* @__PURE__ */ React.createElement("span", { className: "text-[14px] text-[#6B6B6B]" }, "세후 추정 ", /* @__PURE__ */ React.createElement("b", { className: "text-[#0A0A0A]", style: { fontVariantNumeric: "tabular-nums" } }, /* @__PURE__ */ React.createElement(Blur, { on: privacy }, won(Math.round((estimateNetAnnual(hh.income1 * 1e4) + estimateNetAnnual(hh.income2 * 1e4)) / 12))))), /* @__PURE__ */ React.createElement("span", { className: "text-[12px] text-[#B0B0B0] lg:ml-auto" }, "이 값은 부동산 진단 · 대출 · 정책 판정 등 모든 탭에 실시간 반영됩니다")))), /* @__PURE__ */ React.createElement("section", null, /* @__PURE__ */ React.createElement(SectionHeader, { eyebrow: "Allocation", title: "자금 배분" }), /* @__PURE__ */ React.createElement(Card, { className: privacy ? "privacy-on" : "" }, /* @__PURE__ */ React.createElement("div", { className: "p-0" }, /* @__PURE__ */ React.createElement("div", { className: "flex gap-[3px] h-3 mb-4" }, segs.map((s) => s.value > 0 && alloc.totalCash > 0 && /* @__PURE__ */ React.createElement("div", { key: s.id, title: `${s.label} ${pct(s.value)}%`, style: { width: `${Math.min(100, pct(s.value))}%`, background: s.color }, className: "h-full rounded-full transition-all" })), /* @__PURE__ */ React.createElement("div", { className: "h-full rounded-full bg-[#F0F0F0] flex-1" })), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-x-4 gap-y-1.5 text-[13px] mb-5" }, segs.map((s) => /* @__PURE__ */ React.createElement("span", { key: s.id, className: "flex items-center gap-1.5" }, /* @__PURE__ */ React.createElement("span", { className: "w-2.5 h-2.5 rounded-[3px] inline-block", style: { background: s.color } }), /* @__PURE__ */ React.createElement("span", { className: "text-[#525252]" }, s.label), /* @__PURE__ */ React.createElement("b", { style: { fontVariantNumeric: "tabular-nums" } }, pct(s.value), "%"), /* @__PURE__ */ React.createElement("span", { className: "text-[#6B6B6B]" }, "· ", /* @__PURE__ */ React.createElement(Blur, { on: privacy }, manWon(s.value))))), /* @__PURE__ */ React.createElement("span", { className: "flex items-center gap-1.5" }, /* @__PURE__ */ React.createElement("span", { className: "w-2.5 h-2.5 rounded-[3px] inline-block bg-[#F0F0F0] border border-[#E0E0E0]" }), /* @__PURE__ */ React.createElement("span", { className: "text-[#525252]" }, "여유"), /* @__PURE__ */ React.createElement("b", { style: { fontVariantNumeric: "tabular-nums" } }, Math.max(0, pct(free)), "%"))), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 lg:grid-cols-5 gap-3 pt-4 border-t border-[#F0F0F0]" }, /* @__PURE__ */ React.createElement(Field, { label: "총 현금(만원)", value: alloc.totalCash, onChange: (v) => setAlloc({ ...alloc, totalCash: v }), step: 1e3 }), /* @__PURE__ */ React.createElement(Field, { label: "부동산 배정(만원)", value: alloc.realty, onChange: (v) => setAlloc({ ...alloc, realty: v }), step: 1e3 }), /* @__PURE__ */ React.createElement(Field, { label: "돈 모으기 배정(만원)", value: alloc.saving, onChange: (v) => setAlloc({ ...alloc, saving: v }), step: 500 }), /* @__PURE__ */ React.createElement(Field, { label: "결혼식 배정(만원)", value: alloc.wedding, onChange: (v) => setAlloc({ ...alloc, wedding: v }), step: 500 }), /* @__PURE__ */ React.createElement(Field, { label: "자녀 배정(만원)", value: alloc.kids || 0, onChange: (v) => setAlloc({ ...alloc, kids: v }), step: 500 }))))), /* @__PURE__ */ React.createElement("section", null, /* @__PURE__ */ React.createElement(SectionHeader, { eyebrow: "THEMES", title: "테마별 현황" }), /* @__PURE__ */ React.createElement("div", { className: "space-y-3" }, /* @__PURE__ */ React.createElement("button", { onClick: () => setTheme("realty"), className: "w-full text-left" }, /* @__PURE__ */ React.createElement(Card, { className: "hover:border-[#0A0A0A]/50 transition-colors" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between mb-3" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2.5" }, /* @__PURE__ */ React.createElement("span", { className: "w-9 h-9 rounded-xl flex items-center justify-center text-white", style: { background: "#0A0A0A" } }, /* @__PURE__ */ React.createElement(Icon, { name: "home", size: 17 })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "text-[16px] font-bold" }, "부동산"), /* @__PURE__ */ React.createElement("div", { className: "text-[12px] text-[#6B6B6B]" }, themeOf("realty").desc))), /* @__PURE__ */ React.createElement(Icon, { name: "chevron", size: 18, className: "text-[#6B6B6B]" })), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-3 gap-2 text-center" }, /* @__PURE__ */ React.createElement("div", { className: "bg-[#F7F7F7] rounded-xl py-2.5 px-1" }, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-[#6B6B6B] mb-0.5" }, "목표"), /* @__PURE__ */ React.createElement("div", { className: "text-[13px] font-bold truncate" }, realty.target.label.split(" · ")[0], " ", realty.target.label.includes("84") ? "84㎡" : realty.target.label.includes("59") ? "59㎡" : "")), /* @__PURE__ */ React.createElement("div", { className: "bg-[#F7F7F7] rounded-xl py-2.5 px-1" }, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-[#6B6B6B] mb-0.5" }, "필요 자기자본"), /* @__PURE__ */ React.createElement("div", { className: "text-[13px] font-bold" }, /* @__PURE__ */ React.createElement(Blur, { on: privacy }, wonShort(realty.requiredCash)))), /* @__PURE__ */ React.createElement("div", { className: "bg-[#F7F7F7] rounded-xl py-2.5 px-1" }, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-[#6B6B6B] mb-0.5" }, "자기자본 갭"), /* @__PURE__ */ React.createElement("div", { className: "text-[13px] font-bold" }, /* @__PURE__ */ React.createElement(Blur, { on: privacy }, realty.gap > 0 ? wonShort(realty.gap) : "충족")))))), /* @__PURE__ */ React.createElement("button", { onClick: () => setTheme("saving"), className: "w-full text-left" }, /* @__PURE__ */ React.createElement(Card, { className: "hover:border-[#0A0A0A]/50 transition-colors" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between mb-3" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2.5" }, /* @__PURE__ */ React.createElement("span", { className: "w-9 h-9 rounded-xl flex items-center justify-center text-white", style: { background: "#6E6E6E" } }, /* @__PURE__ */ React.createElement(Icon, { name: "trending", size: 17 })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "text-[16px] font-bold" }, "돈 모으기"), /* @__PURE__ */ React.createElement("div", { className: "text-[12px] text-[#6B6B6B]" }, themeOf("saving").desc))), /* @__PURE__ */ React.createElement(Icon, { name: "chevron", size: 18, className: "text-[#6B6B6B]" })), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-3 gap-2 text-center" }, /* @__PURE__ */ React.createElement("div", { className: "bg-[#F7F7F7] rounded-xl py-2.5 px-1" }, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-[#6B6B6B] mb-0.5" }, "절세계좌 잔액"), /* @__PURE__ */ React.createElement("div", { className: "text-[13px] font-bold" }, /* @__PURE__ */ React.createElement(Blur, { on: privacy }, manWon(saving.totalBalance)))), /* @__PURE__ */ React.createElement("div", { className: "bg-[#F7F7F7] rounded-xl py-2.5 px-1" }, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-[#6B6B6B] mb-0.5" }, "올해 납입"), /* @__PURE__ */ React.createElement("div", { className: "text-[13px] font-bold" }, /* @__PURE__ */ React.createElement(Blur, { on: privacy }, manWon(saving.totalPaid)))), /* @__PURE__ */ React.createElement("div", { className: "bg-[#F7F7F7] rounded-xl py-2.5 px-1" }, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-[#6B6B6B] mb-0.5" }, "연 목표 달성률"), /* @__PURE__ */ React.createElement("div", { className: "text-[13px] font-bold text-[#0A0A0A]" }, saving.totalGoal > 0 ? Math.round(saving.totalPaid / saving.totalGoal * 100) : 0, "%"))))), /* @__PURE__ */ React.createElement("button", { onClick: () => setTheme("wedding"), className: "w-full text-left" }, /* @__PURE__ */ React.createElement(Card, { className: "hover:border-[#0A0A0A]/50 transition-colors" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between mb-3" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2.5" }, /* @__PURE__ */ React.createElement("span", { className: "w-9 h-9 rounded-xl flex items-center justify-center text-white", style: { background: "#BDBDBD" } }, /* @__PURE__ */ React.createElement(Icon, { name: "heart", size: 17 })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "text-[16px] font-bold" }, "결혼식"), /* @__PURE__ */ React.createElement("div", { className: "text-[12px] text-[#6B6B6B]" }, themeOf("wedding").desc))), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2" }, wedding.d !== null && /* @__PURE__ */ React.createElement("span", { className: "font-mono text-[12px] font-semibold text-white px-2.5 py-1 rounded-full bg-[#0A0A0A]" }, ddayText(wedding.d)), /* @__PURE__ */ React.createElement(Icon, { name: "chevron", size: 18, className: "text-[#6B6B6B]" }))), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-3 gap-2 text-center" }, /* @__PURE__ */ React.createElement("div", { className: "bg-[#F7F7F7] rounded-xl py-2.5 px-1" }, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-[#6B6B6B] mb-0.5" }, "예산"), /* @__PURE__ */ React.createElement("div", { className: "text-[13px] font-bold" }, manWon(wedding.totalBudget))), /* @__PURE__ */ React.createElement("div", { className: "bg-[#F7F7F7] rounded-xl py-2.5 px-1" }, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-[#6B6B6B] mb-0.5" }, "지출"), /* @__PURE__ */ React.createElement("div", { className: "text-[13px] font-bold text-[#0A0A0A]" }, manWon(wedding.totalSpent))), /* @__PURE__ */ React.createElement("div", { className: "bg-[#F7F7F7] rounded-xl py-2.5 px-1" }, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-[#6B6B6B] mb-0.5" }, "준비 진행률"), /* @__PURE__ */ React.createElement("div", { className: "text-[13px] font-bold" }, wedding.taskDone, "/", wedding.taskTotal))))), /* @__PURE__ */ React.createElement("button", { onClick: () => setTheme("kids"), className: "w-full text-left" }, /* @__PURE__ */ React.createElement(Card, { className: "hover:border-[#0A0A0A]/50 transition-colors" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between mb-3" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2.5" }, /* @__PURE__ */ React.createElement("span", { className: "w-9 h-9 rounded-xl flex items-center justify-center text-white", style: { background: "#8F8F8F" } }, /* @__PURE__ */ React.createElement(Icon, { name: "child", size: 17 })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "text-[16px] font-bold" }, "자녀"), /* @__PURE__ */ React.createElement("div", { className: "text-[12px] text-[#6B6B6B]" }, themeOf("kids").desc))), /* @__PURE__ */ React.createElement(Icon, { name: "chevron", size: 18, className: "text-[#6B6B6B]" })), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-3 gap-2 text-center" }, /* @__PURE__ */ React.createElement("div", { className: "bg-[#F7F7F7] rounded-xl py-2.5 px-1" }, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-[#6B6B6B] mb-0.5" }, "할 일 진행률"), /* @__PURE__ */ React.createElement("div", { className: "text-[13px] font-bold" }, kids.done, "/", kids.total)), /* @__PURE__ */ React.createElement("div", { className: "bg-[#F7F7F7] rounded-xl py-2.5 px-1" }, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-[#6B6B6B] mb-0.5" }, "달성률"), /* @__PURE__ */ React.createElement("div", { className: "text-[13px] font-bold" }, kids.total > 0 ? Math.round(kids.done / kids.total * 100) : 0, "%")), /* @__PURE__ */ React.createElement("div", { className: "bg-[#F7F7F7] rounded-xl py-2.5 px-1" }, /* @__PURE__ */ React.createElement("div", { className: "text-[11px] text-[#6B6B6B] mb-0.5" }, "다음 할 일"), /* @__PURE__ */ React.createElement("div", { className: "text-[13px] font-bold truncate px-1" }, kids.next))))))), /* @__PURE__ */ React.createElement("section", null, /* @__PURE__ */ React.createElement(SectionHeader, { eyebrow: "전체 일정", title: "통합 타임라인" }), /* @__PURE__ */ React.createElement("div", { className: "grid sm:grid-cols-2 gap-3 items-start" }, allMs.length === 0 && /* @__PURE__ */ React.createElement(Card, null, /* @__PURE__ */ React.createElement("div", { className: "text-[14px] text-[#6B6B6B]" }, "등록된 일정이 없어요. 아래에서 추가해 보세요.")), allMs.map((m) => {
    const n = dday(m.date);
    const past = n !== null && n < 0;
    return /* @__PURE__ */ React.createElement(Card, { key: m.id, className: "!p-4 flex items-center justify-between gap-3" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-3 min-w-0" }, /* @__PURE__ */ React.createElement("span", { className: `w-2.5 h-2.5 rounded-full shrink-0 ${past ? "bg-[#D4D4D4]" : "bg-[#0A0A0A]"}` }), /* @__PURE__ */ React.createElement("div", { className: "min-w-0" }, /* @__PURE__ */ React.createElement("div", { className: `text-[15px] font-semibold truncate ${past ? "text-[#6B6B6B]" : ""}` }, m.label), /* @__PURE__ */ React.createElement("div", { className: "text-[13px] text-[#6B6B6B]" }, m.date))), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-1 shrink-0" }, /* @__PURE__ */ React.createElement("span", { className: `font-mono text-[12px] font-semibold px-2.5 py-1 rounded-full ${past ? "bg-[#F0F0F0] text-[#9A9A9A]" : "bg-[#0A0A0A] text-white"}` }, ddayText(n)), !m.fixed && /* @__PURE__ */ React.createElement(IconBtn, { name: "trash", title: "삭제", onClick: () => setMilestones(milestones.filter((x) => x.id !== m.id)) })));
  }), /* @__PURE__ */ React.createElement(Card, { className: "sm:col-span-2" }, /* @__PURE__ */ React.createElement("div", { className: "text-[13px] font-semibold text-[#6B6B6B] mb-2.5" }, "일정 추가 ", /* @__PURE__ */ React.createElement("span", { className: "font-normal" }, "(결혼식 날짜는 결혼식 테마에서 설정하면 자동 표시)")), /* @__PURE__ */ React.createElement("div", { className: "flex gap-2" }, /* @__PURE__ */ React.createElement(TextInput, { value: newMs.label, onChange: (v) => setNewMs({ ...newMs, label: v }), placeholder: "예: 전세 계약 만기", className: "flex-1" }), /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "date",
      "aria-label": "일정 날짜",
...
function LedgerTheme({ privacy, hh }) {
  ...
  useEffect(() => {
    const t = setInterval(() => {
      const d = /* @__PURE__ */ new Date(), k = `${d.getFullYear()}-${String(d.getMonth() + 1).padStart(2, "0")}`;
  ...
  )), /* @__PURE__ */ React.createElement(Card, null, /* @__PURE__ */ React.createElement("div", { className: "text-[13px] text-[#6B6B6B] mb-3" }, "지난달 ", /* @__PURE__ */ React.createElement(Blur, { on: privacy }, wonComma(prevExp)), " → 이번달 ", /* @__PURE__ */ React.createElement(Blur, { on: privacy }, wonComma(monthExp)), prevExp > 0 && /* @__PURE__ */ React.createElement("b", { className: `ml-1 ${monthExp > prevExp ? "text-[#C96A6A]" : "text-[#2E7D5B]"}` }, "(", monthExp >= prevExp ? "+" : "", Math.round((monthExp - prevExp) / prevExp * 100), "%)")), budgetEdit ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "text-[12px] text-[#6B6B6B] mb-2" }, '카테고리별 월 예산(원)을 입력하세요 — 0이면 예산 없음. 합계가 KPI의 "예산 남음"이 돼요.'), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-2" }, LEDGER_CATS.map(([id, label]) => /* @__PURE__ */ React.createElement("div", { key: id, className: "flex items-center gap-2" }, /* @__PURE__ */ React.createElement("span", { className: "text-[13px] w-24 shrink-0" }, label), /* @__PURE__ */ React.createElement(TextInput, { value: budget[id] ? String(budget[id]) : "", onChange: (v) => setBudget({ ...budget, [id]: Number(v.replace(/[^0-9]/g, "")) || 0 }), placeholder: "월 예산(원)", className: "!h-8 !text-[12px]" }))))) : /* @__PURE__ */ React.createElement(React.Fragment, null, catTotals.length === 0 && /* @__PURE__ */ React.createElement("div", { className: "text-[13px] text-[#6B6B6B] py-3 text-center" }, "이 달의 기록이 아직 없어요 — 달력에서 날짜를 눌러 기입해 보세요."), /* @__PURE__ */ React.createElement("div", { className: "space-y-3" }, catTotals.map((c) => {
...
function describeAction(a, hh) {
  ...
  switch (a.name) {
    ...
    case "set_wedding_budget":
      return { icon: "💍", title: `결혼 예산 · ${g.name}`, lines: [g.budget != null ? `예산 → ${manWon(Number(g.budget))}` : "", g.spent != null ? `집행 → ${manWon(Number(g.spent))}` : ""] };
    ...
    case "set_allocation": {
      const L = { totalCash: "총 현금", realty: "내집마련", saving: "절세·저축", wedding: "결혼", kids: "자녀" };
    ...
    case "save_skill":
      return { icon: "🧩", title: `스킬 저장 · ${g.name}`, lines: [`발동: ${g.when}`, clipS(g.instructions, 600)] };
...
function applyAdvisorAction(a, { hh, setHh, setTheme, skills, setSkills }) {
  ...
  switch (a.name) {
    ...
    case "set_wedding_budget": {
      ...
      if (b === void 0 && sp === void 0) return false;
      const hit = matchByText(budget, name, (x) => x.name);
      setKey("wedding-budget-v1", hit ? budget.map((x) => x.id !== hit.id ? x : { ...x, ...b !== void 0 ? { budget: b } : {}, ...sp !== void 0 ? { spent: sp } : {} }) : [...budget, { id: uid(), cat: "기타", name, budget: b ?? 0, spent: sp ?? 0 }]);
      return true;
    }
    case "set_saving_account": {
      const accounts = store.get("saving-accounts-v1", ACCOUNTS_DEFAULT);
    ...
    case "set_allocation": {
      ...
      const patch = {};
      ["totalCash", "realty", "saving", "wedding", "kids"].forEach((k) => {
        const v = numOr(g[k]);
        if (v !== void 0) patch[k] = Math.max(0, v);
      });
      if (!Object.keys(patch).length) return false;
      setKey("home-alloc-v1", { ...alloc, ...patch });
      return true;
    }
    case "set_wedding_info": {
      const info = store.get("wedding-info-v1", { date: "", venue: "" });
...
function Advisor({ user, hh, setHh, theme, setTheme }) {
  ...
  ), /* @__PURE__ */ React.createElement("button", { onClick: () => send(), disabled: busy || !input.trim(), title: "보내기", className: "w-9 h-9 rounded-full bg-[#0A0A0A] text-white flex items-center justify-center shrink-0 disabled:opacity-30" }, /* @__PURE__ */ React.createElement(Icon, { name: "send", size: 15 }))), /* @__PURE__ */ React.createElement("p", { className: "mt-2 text-[12px] text-[#737373] leading-relaxed" }, "대화와 대시보드 요약(소득·자산 포함)이 Anthropic Claude API로 전송돼요(학습에 쓰이지 않는 유료 API). 참고용 상담이며 계약·대출·증여 실행 전 전문가 확인을 권해요.")))));
}
const NAV = [
...
function App({ user }) {
  ...
  const disablePush = async () => {
    ...
    try {
      setPushBusy(true);
      if (token) {
        const r = await withTimeout(authFetch("/api/push-register", { method: "POST", headers: { "content-type": "application/json" }, body: JSON.stringify({ token, remove: true }) }), 15e3, "서버 응답 지연");
      ...
      alert("알림 해제 실패: " + (e && e.message || e) + " — 네트워크 확인 후 다시 시도해 주세요");
    } finally {
      setPushBusy(false);
    }
  };
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "min-h-screen bg-[#F4F4F5] text-[#0A0A0A]", style: { fontFamily: "'Pretendard','Noto Sans KR',sans-serif" } }, /* @__PURE__ */ React.createElement("aside", { className: "hidden lg:flex fixed inset-y-0 left-0 w-60 bg-[#0A0A0A] text-white flex-col z-30" }, /* @__PURE__ */ React.createElement("div", { className: "px-7 pt-9 pb-10" }, /* @__PURE__ */ React.createElement("div", { className: "font-mono text-[10px] font-medium tracking-[0.22em] uppercase text-white/60" }, "Life Plan · 2026"), /* @__PURE__ */ React.createElement("div", { className: "text-[19px] font-bold tracking-tight mt-2" }, "우리 라이프 플랜")), /* @__PURE__ */ React.createElement("div", { className: "px-4 space-y-1.5 flex-1" }, NAV.map((t) => {
