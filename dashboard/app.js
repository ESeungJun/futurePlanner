...
function LhShCalendar({ items }) {
  ...
  })), /* @__PURE__ */ React.createElement("p", { className: "mt-3 text-[12px] text-[#8A8A8A]" }, "위 기관·유형·지역·마감 필터가 캘린더에도 그대로 적용돼요. SH 공고는 마감일이 목록에 없어 게시일만 표시됩니다.")), /* @__PURE__ */ React.createElement(Card, { className: "lg:col-span-2" }, /* @__PURE__ */ React.createElement("h4", { className: "text-[15px] font-bold mb-3", style: { fontVariantNumeric: "tabular-nums" } }, Number(selD.slice(5, 7)), "월 ", Number(selD.slice(8, 10)), "일 일정 ", /* @__PURE__ */ React.createElement("span", { className: "text-[12px] font-semibold text-[#8A8A8A]" }, dayEvents.length, "건")), dayEvents.length === 0 && /* @__PURE__ */ React.createElement("div", { className: "text-[13px] text-[#8A8A8A] py-4 text-center" }, "이 날의 공고 일정이 없어요 — 배지가 있는 날짜를 눌러보세요."), /* @__PURE__ */ React.createElement("ul", { className: "space-y-3" }, dayEvents.map((e, i) => /* @__PURE__ */ React.createElement("li", { key: i, className: "rounded-xl bg-[#FAFAFA] px-3.5 py-3" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 mb-1 flex-wrap" }, /* @__PURE__ */ React.createElement("span", { className: `text-[10px] font-bold px-2 py-0.5 rounded-full ${LHSH_CAL_KIND[e.kind]}` }, e.kind), e.i.agency && /* @__PURE__ */ React.createElement("span", { className: `text-[10px] font-bold px-2 py-0.5 rounded-full ${e.i.agency === "SH" ? "bg-[#2563EB]/10 text-[#2563EB]" : "bg-[#059669]/10 text-[#059669]"}` }, e.i.agency), /* @__PURE__ */ React.createElement("span", { className: "text-[12px] text-[#8A8A8A]" }, e.i.region, e.i.type ? ` · ${e.i.type}` : "")), /* @__PURE__ */ React.createElement("div", { className: "text-[14px] font-bold leading-snug mb-1.5" }, e.i.name), safeUrl(e.i.url) && /* @__PURE__ */ React.createElement("a", { href: safeUrl(e.i.url), target: "_blank", rel: "noopener noreferrer", className: "text-[12px] font-semibold underline underline-offset-4" }, "공고 보기"))))));
}
