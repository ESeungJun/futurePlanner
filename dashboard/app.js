...
function CheongyakTab({ mapKey }) {
  ...
  const focusOn = (i) => {
    ...
    setSel({ id: i.id, lat: i.lat, lng: i.lng, at: Date.now() });
  ...
  const points = useMemo(() => filtered.map((i) => ({ lat: i.lat, lng: i.lng, title: i.name, desc: `${i.region} \xB7 ${wonShortRaw(i.priceMin)}~${wonShortRaw(i.priceMax)}` })), [state.items, f]);
...
function RealtyListTab({ mapKey }) {
  ...
  const points = useMemo(() => filtered.map((i) => ({ lat: i.lat, lng: i.lng, title: i.complex, desc: `${i.dealType} ${i.area}\u33A1 \xB7 ${i.priceText || wonRaw(i.price)}${i.rent ? "/\uC6D4 " + wonRaw(i.rent) : ""}` })), [state.items, f]);
...
function WeddingVendorTab({ kind }) {
  ...
  const [list, setList] = usePersist(`wedding-vendor-${kind}-v4`, def.items.map((v, i) => ({ id: kind + i, ...v })));
  ...
  return /* @__PURE__ */ React.createElement("section", { className: "mb-6" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-end justify-between gap-3 flex-wrap" }, /* @__PURE__ */ React.createElement(SectionHeader, { eyebrow: meta.at ? `${meta.at.slice(0, 10)} \uC2E4\uC2DC\uAC04 \uB9AC\uC11C\uCE58` : "\uC2DC\uC791 \uB9AC\uC2A4\uD2B8 \xB7 \uB300\uD45C \uC5C5\uCCB4 \uC608\uC2DC", title: def.label }), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 mb-4 flex-wrap" }, /* @__PURE__ */ React.createElement(TextInput, { value: area, onChange: setArea, placeholder: "\uC9C0\uC5ED\xB7\uC5C5\uCCB4\uBA85 \uD544\uD130", className: "!w-36 !h-9 !bg-white shadow-sm" }), /* @__PURE__ */ React.createElement(
    ...
    " \uB9AC\uC2A4\uD2B8\uC5D0 \uCD94\uAC00"
  ))), /* @__PURE__ */ React.createElement("div", { className: "mt-3" }, /* @__PURE__ */ React.createElement(InfoNote, null, '\uC2DC\uC791 \uB9AC\uC2A4\uD2B8\uB294 \uB300\uD45C \uC5C5\uCCB4 \uC77C\uBD80 \uC608\uC2DC\uC774\uACE0, \uB300\uD45C \uC0AC\uC9C4\uC740 \uB124\uC774\uBC84 \uAC80\uC0C9 \uC378\uB124\uC77C(\uCEE8\uC149 \uCC38\uACE0\uC6A9)\uC774\uC5D0\uC694. \uAC00\uACA9\uC740 \uC2DC\uC98C\xB7\uAD6C\uC131\uBCC4 \uD3B8\uCC28\uAC00 \uCEE4\uC11C \uACAC\uC801 \uC0C1\uB2F4\uC774 \uC815\uD655\uD574\uC694. "\uCD5C\uC2E0 \uC815\uBCF4\uB85C \uAC31\uC2E0"\uC744 \uB204\uB974\uBA74 \uC9C0\uAE08 \uC778\uAE30 \uC5C5\uCCB4\uB97C \uC6F9\uC5D0\uC11C \uB2E4\uC2DC \uC870\uC0AC\uD558\uACE0, \uC0AC\uC9C4\xB7\uC0AD\uC81C\xB7\uCD94\uAC00\uB294 \uC800\uC7A5\uB418\uC5B4 \uBD80\uBD80\uAC00 \uD568\uAED8 \uBCF4\uB294 \uBAA9\uB85D\uC5D0 \uBC18\uC601\uB3FC\uC694.')));
}
