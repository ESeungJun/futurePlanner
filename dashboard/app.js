...
function PillFilter({ label, value, onChange, options }) {
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "text-[12px] text-[#8A8A8A] mb-1.5" }, label), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-1.5" }, options.map(([v, l]) => /* @__PURE__ */ React.createElement(
    "button",
    {
      key: String(v),
      onClick: () => onChange(v),
...
function CheongyakCalendar({ byDate, srcSel, kindSel, onSrc, onKind, selD, onSelD }) {
  ...
  return /* @__PURE__ */ React.createElement("section", { className: "mb-6" }, /* @__PURE__ */ React.createElement(SectionHeader, { eyebrow: "한눈에 보는 일정 — 청약·무순위·LH·SH·장기전세", title: "통합 공고 캘린더" }), /* @__PURE__ */ React.createElement(Card, null, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between mb-3" }, /* @__PURE__ */ React.createElement("button", { onClick: () => moveMonth(-1), className: "w-9 h-9 rounded-lg hover:bg-[#F5F5F5] flex items-center justify-center" }, /* @__PURE__ */ React.createElement(Icon, { name: "chevron", size: 16, className: "rotate-180" })), /* @__PURE__ */ React.createElement("div", { className: "text-[16px] font-bold", style: { fontVariantNumeric: "tabular-nums" } }, cur.y, "년 ", cur.m + 1, "월 ", /* @__PURE__ */ React.createElement("span", { className: "text-[12px] font-semibold text-[#8A8A8A]" }, "일정 ", monthCnt, "건")), /* @__PURE__ */ React.createElement("button", { onClick: () => moveMonth(1), className: "w-9 h-9 rounded-lg hover:bg-[#F5F5F5] flex items-center justify-center" }, /* @__PURE__ */ React.createElement(Icon, { name: "chevron", size: 16 }))), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-1.5 mb-2" }, Object.entries(CAL_SRC).map(([v, s]) => /* @__PURE__ */ React.createElement(
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { className: "flex flex-col gap-0.5 w-full" }, evs.slice(0, 3).map((e, i) => /* @__PURE__ */ React.createElement("span", { key: i, className: `w-full truncate rounded px-0.5 text-[10px] font-bold leading-4 ${calEvCls(e)}` }, e.kind === "당첨발표" ? "🎉" : "", e.i.name.slice(0, 8))), evs.length > 3 && /* @__PURE__ */ React.createElement("span", { className: "text-[9px] font-bold text-[#8A8A8A]" }, "+", evs.length - 3))
    );
  })), /* @__PURE__ */ React.createElement("p", { className: "mt-3 text-[12px] text-[#8A8A8A]" }, /* @__PURE__ */ React.createElement("b", null, "날짜를 누르면 아래 목록이 그 날의 일정만 보여줘요"), " (같은 날짜를 다시 누르면 해제). 배지의 ", /* @__PURE__ */ React.createElement("b", null, "색은 출처"), "(검정 청약 · 주황 무순위 · 초록 LH · 파랑 SH · 청록 전세), 모양은 일정 종류 — ", /* @__PURE__ */ React.createElement("b", null, "칠해진 배지 접수시작 · 실선 테두리 접수마감 · 점선 테두리 🎉 당첨발표 · 연한색 공고 게시"), ". LH·SH·장기전세는 수도권 공고만 표시돼요.")));
}
...
function EligibilityCheckTab() {
  ...
  })))), /* @__PURE__ */ React.createElement("div", { className: "px-5 py-3.5 border-t border-[#F0F0F0] text-[13px] text-[#8A8A8A] leading-relaxed" }, '공고문에서 "도시근로자 월평균소득의 ', /* @__PURE__ */ React.createElement("b", null, "n%"), '"만 찾아 이 표의 해당 행을 보면 돼요. 맞벌이 완화(예: 미리내집 60㎡ 초과 150%→', /* @__PURE__ */ React.createElement("b", null, "200%"), ", 60㎡ 이하 120%→", /* @__PURE__ */ React.createElement("b", null, "180%"), ")는 완화된 배율 행으로 확인. 기준표는 ", INCOME_BASE_YEAR, " 도시근로자 가구원수별 월평균소득이에요."))), /* @__PURE__ */ React.createElement("section", { className: "mb-6" }, /* @__PURE__ */ React.createElement(SectionHeader, { eyebrow: "소득 외 요건", title: "자산·거주 체크" }), /* @__PURE__ */ React.createElement("div", { className: "grid lg:grid-cols-2 gap-4 items-stretch" }, /* @__PURE__ */ React.createElement(Card, null, /* @__PURE__ */ React.createElement("div", { className: "divide-y divide-[#F0F0F0]" }, /* @__PURE__ */ React.createElement(Stat, { label: `총자산 ${manWon(p.asset)} / 한도 ${manWon(p.assetCap)}`, value: assetOk ? "통과" : "초과", tone: assetOk ? "good" : "bad" }), /* @__PURE__ */ React.createElement(Stat, { label: `차량가액 ${manWon(p.car)} / 한도 ${manWon(p.carCap)}`, value: carOk ? "통과" : "초과", tone: carOk ? "good" : "bad" })), /* @__PURE__ */ React.createElement("p", { className: "mt-3 text-[13px] text-[#8A8A8A] leading-relaxed" }, "이자·배당은 ", /* @__PURE__ */ React.createElement("b", null, "재산소득으로 소득에 합산"), "될 수 있어요 — 경계선 판정일 땐 예금이자(월 환산)를 소득에 더해 보수적으로 보세요.")), /* @__PURE__ */ React.createElement(Card, null, /* @__PURE__ */ React.createElement("ul", { className: "space-y-2.5 text-[14px] text-[#3D3D3D] leading-relaxed" }, /* @__PURE__ */ React.createElement("li", { className: "flex gap-2" }, /* @__PURE__ */ React.createElement(Icon, { name: "chevron", size: 15, className: "mt-0.5 shrink-0 text-[#8A8A8A]" }), /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement("b", null, "SH 장기전세·미리내집"), ": 공고일 현재 ", /* @__PURE__ */ React.createElement("b", null, "서울시 거주"), " 필수")), /* @__PURE__ */ React.createElement("li", { className: "flex gap-2" }, /* @__PURE__ */ React.createElement(Icon, { name: "chevron", size: 15, className: "mt-0.5 shrink-0 text-[#8A8A8A]" }), /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement("b", null, "과천 등 투기과열지구 분양"), ": 수도권 거주자면 신청은 가능하지만 ", /* @__PURE__ */ React.createElement("b", null, "해당지역 2년 이상 거주자에게 우선공급"), " — 인기 단지는 사실상 여기서 마감")), /* @__PURE__ */ React.createElement("li", { className: "flex gap-2" }, /* @__PURE__ */ React.createElement(Icon, { name: "chevron", size: 15, className: "mt-0.5 shrink-0 text-[#8A8A8A]" }), /* @__PURE__ */ React.createElement("span", null, "거주기간은 ", /* @__PURE__ */ React.createElement("b", null, "모집공고일 기준 역산"), " — 과천 청약이 목표면 분양 예상 시점 2년 전 전입 필요")), /* @__PURE__ */ React.createElement("li", { className: "flex gap-2" }, /* @__PURE__ */ React.createElement(Icon, { name: "chevron", size: 15, className: "mt-0.5 shrink-0 text-[#8A8A8A]" }), /* @__PURE__ */ React.createElement("span", null, "혼인 7년 이내·5년 무주택 이력·재당첨 제한은 공고문 원문에서 최종 확인")))))));
}
const PUBLIC_TYPES = [
...
function GuestSideCard({ title, list, nv, setNv, onAdd, onToggle, onRemove, onPatch, onMove, onReorder, relOptions = [] }) {
  ...
  return /* @__PURE__ */ React.createElement(Card, { className: "h-full" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between mb-3" }, /* @__PURE__ */ React.createElement("h4", { className: "text-[15px] font-bold" }, title), /* @__PURE__ */ React.createElement("span", { className: "font-mono text-[12px] font-semibold text-[#8A8A8A]" }, guestHeads(list), "명 · 청모 ", guestHeads(list.filter((g) => g.chungmo)), "명")), /* @__PURE__ */ React.createElement("div", { className: "flex gap-2 mb-3" }, /* @__PURE__ */ React.createElement(TextInput, { value: nv.name, onChange: (v) => setNv({ ...nv, name: v }), placeholder: "이름 *", className: "flex-1 min-w-0" }), /* @__PURE__ */ React.createElement(TextInput, { value: nv.rel, onChange: (v) => setNv({ ...nv, rel: v }), placeholder: "관계 (예: 친구·회사)", className: "flex-1 min-w-0", list: relDlId }), /* @__PURE__ */ React.createElement(NumInput, { value: nv.cnt, onChange: (v) => setNv({ ...nv, cnt: v }), className: "!w-[64px] shrink-0 text-center" }), /* @__PURE__ */ React.createElement("button", { onClick: onAdd, className: "h-10 px-4 rounded-lg bg-[#0A0A0A] text-white text-[13px] font-semibold shrink-0 flex items-center gap-1" }, /* @__PURE__ */ React.createElement(Icon, { name: "plus", size: 13 }), " 추가")), /* @__PURE__ */ React.createElement("datalist", { id: relDlId }, relOptions.map((r) => /* @__PURE__ */ React.createElement("option", { key: r, value: r }))), list.length > 1 && /* @__PURE__ */ React.createElement("div", { className: "flex gap-1 mb-2" }, GUEST_SORTS.map(([k, l]) => /* @__PURE__ */ React.createElement(
    ...
    "button",
    {
      ...
      className: `h-7 px-2.5 rounded-full text-[11px] font-semibold transition-colors ${activeRel === "all" ? "bg-[#0A0A0A] text-white" : "bg-white border border-[#E5E5E5] text-[#8A8A8A] hover:bg-[#FAFAFA]"}`
    },
    "전체 ",
    guestHeads(list),
    "명"
    ...
    "button",
    {
      ...
      className: `h-7 px-2.5 rounded-full text-[11px] font-semibold transition-colors ${activeRel === k ? "bg-[#0A0A0A] text-white" : "bg-white border border-[#E5E5E5] text-[#8A8A8A] hover:bg-[#FAFAFA]"}`
    },
    k || "관계 미지정",
    " ",
    n,
    ...
    /* @__PURE__ */ React.createElement(Icon, { name: "chevron", size: 11, className: "rotate-90" })
  )), /* @__PURE__ */ React.createElement("span", { className: "text-[14px] font-semibold flex-1 min-w-0 truncate" }, g.name), /* @__PURE__ */ React.createElement("span", { className: "text-[13px] text-[#8A8A8A] shrink-0" }, g.rel || "-"), /* @__PURE__ */ React.createElement("span", { className: "flex items-center gap-0.5 shrink-0", title: "동반 포함 인원수" }, /* @__PURE__ */ React.createElement(NumInput, { value: guestCnt(g), onChange: (v) => onPatch(g.id, { cnt: Math.max(1, Number(v) || 1) }), className: "!h-7 !w-11 !px-1 text-center !text-[12px]" }), /* @__PURE__ */ React.createElement("span", { className: "text-[11px] text-[#8A8A8A]" }, "명")), /* @__PURE__ */ React.createElement(
    "button",
    {
...
const CARD_DEDUCTION_LIMIT = (gross) => gross <= 7e3 ? 300 : gross <= 12e3 ? 250 : 200;
...
function WeddingPaymentGuide({ hh, privacy, remaining }) {
  ...
  return /* @__PURE__ */ React.createElement("section", { className: "mb-6" }, /* @__PURE__ */ React.createElement(SectionHeader, { eyebrow: "잔금 결제 가이드", title: "잔금, 누가 어떻게 결제할까" }), /* @__PURE__ */ React.createElement(Card, { className: "!border-[#0A0A0A] border" }, /* @__PURE__ */ React.createElement("div", { className: "text-[13px] text-[#8A8A8A] mb-1" }, "잔금 ", manWon(amount), pay.amount == null && ` (예산표 ${WEDDING_HALL_CAT} 예산 − 지출 연동)`, " · 우리 부부 추천"), amount <= 0 ? /* @__PURE__ */ React.createElement("div", { className: "text-[14px] text-[#525252]" }, "남은 잔금이 없어요. 아래에 결제할 금액을 넣으면 계산해 드려요.") : /* @__PURE__ */ React.createElement(React.Fragment, null, plan.local > 0 && /* @__PURE__ */ React.createElement("div", { className: "text-[15px] font-bold mt-1" }, "🪙 지역화폐 ", manWon(plan.local), " 먼저 → 결제 즉시 ", eff(plan.localSave), " 할인"), lines.map((l) => /* @__PURE__ */ React.createElement("div", { key: l.name, className: "text-[15px] font-bold mt-1" }, l.name, " 명의 · ", l.parts)), plan.best.a.cash + plan.best.b.cash === 0 && pay.cardRate > 0 && /* @__PURE__ */ React.createElement("div", { className: "mt-2 text-[13px] text-[#525252] bg-[#FAFAFA] rounded-lg px-3 py-2" }, "💡 잔금이 커서 ", /* @__PURE__ */ React.createElement("b", null, "카드 15%만으로도 두 사람 공제한도가 다 차요"), " — 현금영수증으로 바꿔도 공제는 늘지 않고 카드 적립만 잃어요. 카드 월 적립 한도가 낮다면 실제 적립률로 고쳐 다시 보세요."), /* @__PURE__ */ React.createElement("div", { className: "mt-2 text-[14px] text-[#525252]" }, "예상 효과 ", /* @__PURE__ */ React.createElement("b", { className: "text-[#0A0A0A]" }, eff(plan.best.total)), " ", /* @__PURE__ */ React.createElement("span", { className: "text-[12px] text-[#8A8A8A]" }, "(연말정산 환급 + 카드 적립", plan.local > 0 ? " + 지역화폐 할인" : "", ")")), /* @__PURE__ */ React.createElement("div", { className: "grid sm:grid-cols-2 gap-2 mt-3" }, altRows.map(([label, v]) => /* @__PURE__ */ React.createElement("div", { key: label, className: "flex justify-between bg-[#FAFAFA] rounded-lg px-3 py-2 text-[13px]" }, /* @__PURE__ */ React.createElement("span", { className: "text-[#525252]" }, label), /* @__PURE__ */ React.createElement("span", { className: "font-semibold", style: { fontVariantNumeric: "tabular-nums" } }, eff(v)))))), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-3 mt-4" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "text-[12px] text-[#8A8A8A] block mb-1" }, "결제할 잔금(만원)"), /* @__PURE__ */ React.createElement(NumInput, { value: amount, onChange: (v) => set("amount", v) })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "text-[12px] text-[#8A8A8A] block mb-1" }, n1, " 올해 사용액(만원)"), /* @__PURE__ */ React.createElement(NumInput, { value: used1, onChange: (v) => set("used1", v) })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "text-[12px] text-[#8A8A8A] block mb-1" }, n2, " 올해 사용액(만원)"), /* @__PURE__ */ React.createElement(NumInput, { value: used2, onChange: (v) => set("used2", v) })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "text-[12px] text-[#8A8A8A] block mb-1" }, "카드 적립률(%)"), /* @__PURE__ */ React.createElement(NumInput, { value: pay.cardRate, onChange: (v) => set("cardRate", v) }))), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-3 gap-3 mt-3 items-end" }, /* @__PURE__ */ React.createElement("button", { onClick: () => set("localOn", !pay.localOn), className: `h-10 rounded-lg text-[13px] font-semibold ${pay.localOn ? "bg-[#0A0A0A] text-white" : "bg-[#F5F5F5] text-[#525252]"}` }, pay.localOn ? "지역화폐 가능 ✓" : "지역화폐 가능?"), pay.localOn && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "text-[12px] text-[#8A8A8A] block mb-1" }, "할인율(%)"), /* @__PURE__ */ React.createElement(NumInput, { value: pay.localRate, onChange: (v) => set("localRate", v) })), pay.localOn && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "text-[12px] text-[#8A8A8A] block mb-1" }, "쓸 수 있는 한도(만원)"), /* @__PURE__ */ React.createElement(NumInput, { value: pay.localLimit, onChange: (v) => set("localLimit", v) }))), /* @__PURE__ */ React.createElement("div", { className: "mt-3 grid sm:grid-cols-2 gap-2 text-[12px] text-[#8A8A8A]" }, [[n1, g1, used1], [n2, g2, used2]].map(([n, g, u]) => /* @__PURE__ */ React.createElement("div", { key: n }, n, " · 총급여 ", /* @__PURE__ */ React.createElement(Blur, { on: privacy }, manWon(g)), " · 25% 문턱 ", manWon(Math.round(g * 0.25)), u < g * 0.25 && " (아직 미달)", " · 공제한도 ", CARD_DEDUCTION_LIMIT(g), "만 · 한계세율 ", (marginalTaxRate(g * 1e4) * 100).toFixed(1), "%"))), /* @__PURE__ */ React.createElement("div", { className: "mt-3" }, /* @__PURE__ */ React.createElement(InfoNote, null, "올해 사용액은 잔금을 빼고 연말까지 쓸 카드·현금영수증 합계 예상치예요(비워두면 연봉의 30%로 가정). 소득공제는 기본 한도만 반영한 추정치예요."))), /* @__PURE__ */ React.createElement("div", { className: "grid lg:grid-cols-2 gap-3 mt-3 items-start" }, /* @__PURE__ */ React.createElement(Card, { className: "!p-4" }, /* @__PURE__ */ React.createElement("div", { className: "flex justify-between items-center mb-2.5" }, /* @__PURE__ */ React.createElement("span", { className: "text-[13px] font-semibold text-[#8A8A8A]" }, "결제 직전 체크리스트"), /* @__PURE__ */ React.createElement("span", { className: "font-mono text-[12px] font-bold" }, checksDone, "/", WEDDING_PAY_CHECKS.length)), /* @__PURE__ */ React.createElement("div", { className: "space-y-1.5" }, WEDDING_PAY_CHECKS.map((t, i) => /* @__PURE__ */ React.createElement("label", { key: i, className: "flex gap-2 items-start text-[13px] cursor-pointer" }, /* @__PURE__ */ React.createElement("input", { type: "checkbox", checked: !!pay.checks[i], onChange: () => set("checks", { ...pay.checks, [i]: !pay.checks[i] }), className: "mt-0.5 accent-[#0A0A0A]" }), /* @__PURE__ */ React.createElement("span", { className: pay.checks[i] ? "line-through text-[#B0B0B0]" : "text-[#3D3D3D]" }, t))))), /* @__PURE__ */ React.createElement(Card, { className: "!p-4" }, /* @__PURE__ */ React.createElement("div", { className: "text-[13px] font-semibold text-[#8A8A8A] mb-2.5" }, "판단 기준"), /* @__PURE__ */ React.createElement("ul", { className: "space-y-2 text-[13px] text-[#3D3D3D] leading-relaxed" }, /* @__PURE__ */ React.createElement("li", null, "🪙 ", /* @__PURE__ */ React.createElement("b", null, "지역화폐가 되면 제일 먼저"), " — 7~10% 할인이 결제 즉시. 연말정산보다 클 수 있어요."), /* @__PURE__ */ React.createElement("li", null, "🧾 ", /* @__PURE__ */ React.createElement("b", null, "공제율은 현금영수증 30% vs 카드 15%"), " — 공제한도가 남아 있으면 보통 현금영수증이 유리해요."), /* @__PURE__ */ React.createElement("li", null, "💳 ", /* @__PURE__ */ React.createElement("b", null, "연봉이 낮거나 한도가 없으면 카드"), " — 세금 혜택이 작아 적립·캐시백·마일리지가 더 클 수 있어요. 적립률보다 ", /* @__PURE__ */ React.createElement("b", null, "월 적립 한도"), "를 먼저 보세요."), /* @__PURE__ */ React.createElement("li", null, "👤 ", /* @__PURE__ */ React.createElement("b", null, "명의는 25% 문턱을 이미 넘긴 사람, 둘 다면 연봉 높은 사람"), " — 한 사람 한도가 차면 나눠서 결제하세요."), /* @__PURE__ */ React.createElement("li", null, "💰 현금 결제 시 식대·대관료 할인이나 서비스를 주는 곳도 있고, 부담되면 무이자 할부도 비교해 보세요.")))));
}
...
function WeddingBudgetTab({ budget, setBudget, alloc }) {
  ...
  return /* @__PURE__ */ React.createElement("section", { className: "mb-6" }, /* @__PURE__ */ React.createElement(SectionHeader, { eyebrow: "2025~26 결혼 준비 후기 기반", title: "예식 비용 예산표" }), /* @__PURE__ */ React.createElement(Card, { className: "mb-4" }, /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-3 gap-3 mb-3" }, [["예산", totalBudget], ["실제 지출", totalSpent], ["남은 예산", totalBudget - totalSpent]].map(([l, v]) => /* @__PURE__ */ React.createElement("div", { key: l }, /* @__PURE__ */ React.createElement("div", { className: "text-[12px] text-[#8A8A8A] mb-0.5" }, l), /* @__PURE__ */ React.createElement("div", { className: "text-[19px] font-bold tracking-tight", style: { fontVariantNumeric: "tabular-nums" } }, manWon(v))))), /* @__PURE__ */ React.createElement(ProgressBar, { ratio: totalBudget > 0 ? totalSpent / totalBudget : 0 }), /* @__PURE__ */ React.createElement("div", { className: "mt-2 flex justify-between text-[13px] text-[#8A8A8A]" }, /* @__PURE__ */ React.createElement("span", null, "집행률 ", /* @__PURE__ */ React.createElement("b", { className: "text-[#0A0A0A]" }, totalBudget > 0 ? Math.round(totalSpent / totalBudget * 100) : 0, "%"), " · 항목 ", budget.length, "개 · 지출 기록 ", budget.filter((b) => b.spent > 0).length, "개"), alloc.wedding > 0 && /* @__PURE__ */ React.createElement("span", null, "홈 배정 ", manWon(alloc.wedding), " 대비 ", Math.round(totalBudget / alloc.wedding * 100), "% ", totalBudget > alloc.wedding && /* @__PURE__ */ React.createElement("b", { className: "text-[#0A0A0A] underline underline-offset-2" }, "초과"))), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2 mt-4" }, cats.map((c) => {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { className: `text-[12px] truncate ${open[c] ? "text-white/60" : "text-[#8A8A8A]"}` }, c),
      /* @__PURE__ */ React.createElement("div", { className: "text-[13px] font-bold", style: { fontVariantNumeric: "tabular-nums" } }, manWon(ss), " ", /* @__PURE__ */ React.createElement("span", { className: `font-normal ${open[c] ? "text-white/60" : "text-[#8A8A8A]"}` }, "/ ", manWon(bb)))
    );
    ...
    return /* @__PURE__ */ React.createElement(Card, { key: c, id: `wb-${encodeURIComponent(c)}`, className: "!p-0 scroll-mt-20 overflow-hidden" }, /* @__PURE__ */ React.createElement("button", { onClick: () => setOpenCat(c, !open[c]), className: "w-full flex items-center gap-3 px-5 py-4 text-left hover:bg-[#FAFAFA]" }, /* @__PURE__ */ React.createElement(Icon, { name: "chevron", size: 16, className: `shrink-0 text-[#8A8A8A] transition-transform ${open[c] ? "rotate-90" : ""}` }), /* @__PURE__ */ React.createElement("h4", { className: "text-[15px] font-bold flex-1 min-w-0 truncate" }, c, " ", /* @__PURE__ */ React.createElement("span", { className: "font-normal text-[12px] text-[#8A8A8A] ml-1" }, all.length, "개")), /* @__PURE__ */ React.createElement("div", { className: "hidden sm:block w-32" }, /* @__PURE__ */ React.createElement(ProgressBar, { ratio: bb > 0 ? ss / bb : 0, height: 4 })), /* @__PURE__ */ React.createElement("span", { className: "font-mono text-[13px] shrink-0", style: { fontVariantNumeric: "tabular-nums" } }, /* @__PURE__ */ React.createElement("b", null, manWon(ss)), " ", /* @__PURE__ */ React.createElement("span", { className: "text-[#8A8A8A]" }, "/ ", manWon(bb)))), open[c] && /* @__PURE__ */ React.createElement("div", { className: "px-5 pb-4 border-t border-[#F0F0F0]" }, /* @__PURE__ */ React.createElement("div", { className: `${BUDGET_ROW} text-[11px] text-[#8A8A8A] py-2` }, /* @__PURE__ */ React.createElement("span", null, "항목"), /* @__PURE__ */ React.createElement("span", { className: "hidden sm:block" }, "메모"), /* @__PURE__ */ React.createElement("span", { className: "text-right" }, "예산(만)"), /* @__PURE__ */ React.createElement("span", { className: "text-right" }, "지출(만)"), /* @__PURE__ */ React.createElement("span", null)), /* @__PURE__ */ React.createElement("div", { className: "divide-y divide-[#F4F4F4]" }, list.map((b) => /* @__PURE__ */ React.createElement("div", { key: b.id, className: `${BUDGET_ROW} py-1.5 items-center` }, /* @__PURE__ */ React.createElement(TextInput, { value: b.name, onChange: (v) => patch(b.id, "name", v), className: "!h-9 font-semibold" }), /* @__PURE__ */ React.createElement("div", { className: "col-span-4 sm:col-span-1 order-last sm:order-none min-w-0" }, b.linkLabel && /* @__PURE__ */ React.createElement("div", { className: "text-[11px] font-semibold text-[#0A0A0A] px-1 truncate", title: b.linkLabel }, "🔗 ", b.linkLabel), /* @__PURE__ */ React.createElement(TextInput, { value: b.note || "", onChange: (v) => patch(b.id, "note", v), placeholder: "메모 (업체·결제일·조건)", className: "!h-7 !text-[12px] !bg-transparent !px-1 text-[#8A8A8A]" })), /* @__PURE__ */ React.createElement(NumInput, { value: b.budget, onChange: (v) => patch(b.id, "budget", v), className: "!h-9 !px-2 !text-[13px] text-right" }), /* @__PURE__ */ React.createElement(NumInput, { value: b.spent, onChange: (v) => patch(b.id, "spent", v), className: `!h-9 !px-2 !text-[13px] text-right ${b.spent > b.budget && b.budget > 0 ? "!text-[#C0392B]" : ""}` }), /* @__PURE__ */ React.createElement(IconBtn, { name: "trash", title: "항목 삭제", onClick: () => setBudget(budget.filter((x) => x.id !== b.id)), className: "!w-8 !h-9" }))), onlyOpen && list.length === 0 && /* @__PURE__ */ React.createElement("div", { className: "text-[12px] text-[#B0B0B0] py-2" }, "모두 지출을 기록했어요")), /* @__PURE__ */ React.createElement("div", { className: "flex gap-1.5 mt-3" }, /* @__PURE__ */ React.createElement(
      TextInput,
      {
        value: n.name,
...
function WeddingTheme({ hh, privacy }) {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(PhaseGauge, { themeId: "wedding" }), /* @__PURE__ */ React.createElement(PillNav, { tabs: WEDDING_TABS, tab, setTab }), tab === "overview" && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("section", { className: "mb-6" }, /* @__PURE__ */ React.createElement("div", { onClick: burst, className: "relative overflow-hidden rounded-3xl bg-[#0A0A0A] text-white px-6 py-12 text-center cursor-pointer select-none", title: "클릭해 보세요 🤍" }, /* @__PURE__ */ React.createElement(HeartField, null), bursts.map((p) => /* @__PURE__ */ React.createElement("span", { key: p.id, className: "heart-b text-white/80", style: { "--x": p.x, "--y": p.y } }, /* @__PURE__ */ React.createElement(Icon, { name: "heart", size: p.s, fill: "currentColor" }))), /* @__PURE__ */ React.createElement("div", { className: "relative font-mono text-[11px] font-medium tracking-[0.26em] uppercase text-white/45 mb-3" }, "Our Wedding Day"), /* @__PURE__ */ React.createElement("div", { className: "relative font-mono text-[56px] sm:text-[72px] leading-none font-semibold tracking-tight" }, d === null ? "D - ?" : ddayText(d)), /* @__PURE__ */ React.createElement("div", { className: "relative mt-4 text-[14px] text-white/60" }, info.date ? `${info.date}${info.venue ? " · " + info.venue : ""}` : "아래에서 예식일을 설정해 주세요")), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-3 mt-3" }, /* @__PURE__ */ React.createElement(Kpi, { icon: "check2", label: "체크리스트 진행", value: `${taskDone}/${taskTotal}` }), /* @__PURE__ */ React.createElement(Kpi, { icon: "piggy", label: "예산 집행률", value: `${Math.round(totalSpent / Math.max(1, totalBudget) * 100)}%`, accent: "#525252" }), /* @__PURE__ */ React.createElement(Kpi, { icon: "users", label: "하객 리스트", value: `${guestHeads(guestsAll)}명`, accent: "#8A8A8A" }), /* @__PURE__ */ React.createElement(Kpi, { icon: "building", label: "식장 후보", value: `${venueList.length}곳`, accent: "#B0B0B0" })), /* @__PURE__ */ React.createElement(Card, { className: "mt-3 !p-4" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between mb-3" }, /* @__PURE__ */ React.createElement("div", { className: "text-[13px] font-semibold text-[#8A8A8A]" }, "확정한 업체"), /* @__PURE__ */ React.createElement("button", { onClick: () => setTab("vendors"), className: "text-[12px] font-semibold text-[#525252] underline underline-offset-4" }, "후보 비교하러 가기")), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 lg:grid-cols-5 gap-2" }, [["venue", "🏛", "식장"], ["studio", "📸", "스튜디오"], ["dress", "👗", "드레스"], ["makeup", "💄", "메이크업"], ["snap", "🎞", "스냅"]].map(([k, ic, label]) => {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { className: `text-[11px] mb-0.5 ${c ? "text-white/60" : "text-[#8A8A8A]"}` }, ic, " ", label, " ", c && "· 확정 ✓"),
...
function applyAdvisorAction(a, { hh, setHh, setTheme, skills, setSkills }) {
  ...
  switch (a.name) {
    ...
    case "set_wedding_budget": {
      ...
      setKey("wedding-budget-v1", hit ? budget.map((x) => x.id !== hit.id ? x : { ...x, ...b !== void 0 ? { budget: b } : {}, ...sp !== void 0 ? { spent: sp } : {} }) : [...budget, { id: uid(), name, budget: b ?? 0, spent: sp ?? 0 }]);
      return true;
    }
    case "set_saving_account": {
      const accounts = store.get("saving-accounts-v1", ACCOUNTS_DEFAULT);
...
function Advisor({ user, hh, setHh, theme, setTheme }) {
  ...
  const applyAll = (msgId) => {
    ...
    if (!m) return;
    const result = {};
    (m.actions || []).filter((a) => a.status === "pending").forEach((a) => {
  ...
  ), /* @__PURE__ */ React.createElement("button", { onClick: () => send(), disabled: busy || !input.trim(), title: "보내기", className: "w-9 h-9 rounded-full bg-[#0A0A0A] text-white flex items-center justify-center shrink-0 disabled:opacity-30" }, /* @__PURE__ */ React.createElement(Icon, { name: "send", size: 15 }))), /* @__PURE__ */ React.createElement("p", { className: "mt-2 text-[10.5px] text-[#B0B0B0] leading-relaxed" }, "대화와 대시보드 요약(소득·자산 포함)이 Claude(키 없으면 Gemini)에 전송돼요. 참고용 상담이며 계약·대출·증여 실행 전 전문가 확인을 권해요.")))));
}
const NAV = [
