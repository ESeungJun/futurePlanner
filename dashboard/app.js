...
function WeddingBudgetTab({ budget, setBudget, alloc }) {
  ...
  return /* @__PURE__ */ React.createElement("section", { className: "mb-6" }, /* @__PURE__ */ React.createElement(SectionHeader, { eyebrow: "2025~26 결혼 준비 후기 기반", title: "예식 비용 예산표" }), /* @__PURE__ */ React.createElement(Card, { className: "mb-4" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-end justify-between gap-3 flex-wrap" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "text-[12px] text-[#6B6B6B] mb-0.5" }, "예상 총액"), /* @__PURE__ */ React.createElement("div", { className: "text-[26px] font-bold tracking-tight", style: { fontVariantNumeric: "tabular-nums" } }, manWon(total))), /* @__PURE__ */ React.createElement("div", { className: "text-[13px] text-[#6B6B6B] text-right" }, "항목 ", budget.length, "개", alloc.wedding > 0 && /* @__PURE__ */ React.createElement("div", null, "홈 배정 ", manWon(alloc.wedding), " 대비 ", /* @__PURE__ */ React.createElement("b", { className: "text-[#0A0A0A]" }, Math.round(total / alloc.wedding * 100), "%"), total > alloc.wedding && /* @__PURE__ */ React.createElement("b", { className: "text-[#0A0A0A] underline underline-offset-2 ml-1" }, "초과")))), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2 mt-4" }, cats.map((c) => {
  ...
  } }), /* @__PURE__ */ React.createElement("button", { onClick: addCat, className: "h-10 px-4 rounded-lg bg-[#0A0A0A] text-white font-semibold text-[14px] shrink-0" }, "추가")), /* @__PURE__ */ React.createElement("div", { className: "mt-2 text-[12px] text-[#6B6B6B]" }, "카테고리 안의 항목을 모두 지우면 카테고리도 사라져요."))), /* @__PURE__ */ React.createElement("div", { className: "mt-3" }, /* @__PURE__ */ React.createElement(InfoNote, null, "🔗 표시 항목은 식장·스드메 탭의 확정 업체와 신혼여행 ★1순위 가격이 자동으로 들어가요(가격 범위는 가운데 값, 식대는 하객 리스트 인원 × 1인 식대). 기본 금액은 2025~26 후기·업계 조사의 대표값(추정)이에요 — 견적을 받거나 결제하면 그 금액으로 고쳐 적으세요.")));
}
