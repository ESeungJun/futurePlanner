...
function LongLeaseTab() {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("section", { className: "mb-6" }, /* @__PURE__ */ React.createElement(SectionHeader, { eyebrow: "개념 정리", title: "장기전세주택 한눈에" }), /* @__PURE__ */ React.createElement("div", { className: "grid lg:grid-cols-3 gap-4 items-stretch" }, LONGLEASE_INFO.map((c, i) => /* @__PURE__ */ React.createElement(Card, { key: i, className: "h-full" }, /* @__PURE__ */ React.createElement("div", { className: "text-[15px] font-bold mb-2" }, c.title), /* @__PURE__ */ React.createElement("p", { className: "text-[13px] text-[#525252] leading-relaxed" }, c.body))))), /* @__PURE__ */ React.createElement("section", { className: "mb-6" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-end justify-between gap-3 flex-wrap" }, /* @__PURE__ */ React.createElement(SectionHeader, { eyebrow: data.at ? `${String(data.at).slice(0, 10)} 실시간 리서치` : "온디맨드 조사", title: "현재·예정 공고 리서치" }), /* @__PURE__ */ React.createElement("div", { className: "mb-4" }, /* @__PURE__ */ React.createElement(LiveUpdateBtn, { topic: "longlease", onData: (j) => {
    const v = { items: j.items, at: j.fetchedAt };
    store.set("longlease-data-v1", v);
    setData(v);
  } }))), data.items.length === 0 && /* @__PURE__ */ React.createElement(Card, null, /* @__PURE__ */ React.createElement("div", { className: "text-[14px] text-[#8A8A8A]" }, '"최신 정보로 갱신"을 누르면 지금 신청 가능한 수도권 장기전세 공고를 조사해요. 접수 일정은 반드시 아래 공식 사이트에서 최종 확인하세요.')), /* @__PURE__ */ React.createElement("div", { className: "grid lg:grid-cols-2 gap-4 items-stretch" }, data.items.map((it, i) => /* @__PURE__ */ React.createElement(Card, { key: i, className: "h-full flex flex-col" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-start justify-between gap-3 mb-2" }, /* @__PURE__ */ React.createElement("div", { className: "min-w-0" }, /* @__PURE__ */ React.createElement("div", { className: "text-[16px] font-bold" }, it.name), /* @__PURE__ */ React.createElement("div", { className: "text-[13px] text-[#8A8A8A] mt-0.5" }, it.area)), /* @__PURE__ */ React.createElement(ToneBadge, { tone: "neutral" }, it.agency)), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 gap-y-1.5 text-[13px] text-[#3D3D3D] mb-2" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "text-[#8A8A8A]" }, "접수 "), it.deadline), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "text-[#8A8A8A]" }, "공급 "), it.supply), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "text-[#8A8A8A]" }, "기준 "), it.income)), /* @__PURE__ */ React.createElement("p", { className: "text-[13px] text-[#525252] leading-relaxed mb-3 flex-1" }, it.note), /* @__PURE__ */ React.createElement("div", { className: "mt-auto flex gap-3" }, it.link && /* @__PURE__ */ React.createElement("a", { href: it.link, target: "_blank", rel: "noopener noreferrer", className: "text-[13px] font-semibold underline underline-offset-4" }, "공고 보기 ", /* @__PURE__ */ React.createElement("span", { className: "text-[11px] text-[#2E7D5B]" }, "✓ 링크 확인됨")), /* @__PURE__ */ React.createElement("a", { href: naverSearch(`${it.name} 장기전세 공고`), target: "_blank", rel: "noopener noreferrer", className: "text-[13px] font-semibold text-[#8A8A8A] underline underline-offset-4" }, "네이버 검색"))))), /* @__PURE__ */ React.createElement("div", { className: "mt-3" }, /* @__PURE__ */ React.createElement(InfoNote, null, "AI 조사 결과에서 ", /* @__PURE__ */ React.createElement("b", null, "서버가 링크를 실제 접속해 확인된 것만 표시"), '하고, 마감일이 과거로 확인된 공고는 자동 제외해요. 그래도 일정·기준은 추정일 수 있으니 신청 판단은 반드시 공식 공고문으로 — 확실한 실시간 공고는 위 "실시간 공고 (LH)" 세그먼트가 공식 데이터예요.'))), /* @__PURE__ */ React.createElement("section", { className: "mb-6" }, /* @__PURE__ */ React.createElement(SectionHeader, { eyebrow: "바로가기", title: "공식 공고 사이트" }), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-3" }, LONGLEASE_LINKS.map(([label, url]) => /* @__PURE__ */ React.createElement(
    "a",
    {
      key: url,
      href: url,
...
function PublicHousingTab() {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "mb-5 flex items-center gap-1.5 flex-wrap" }, [["types", "📚 유형 알아보기"], ["notices", "📢 실시간 공고 (LH)"], ["longlease", "🏠 장기전세 심화"]].map(([id, label]) => /* @__PURE__ */ React.createElement(
    ...
    label
  ))), seg === "types" && /* @__PURE__ */ React.createElement("section", { className: "mb-6" }, /* @__PURE__ */ React.createElement(SectionHeader, { eyebrow: "공공주택 A to Z", title: "유형별 한눈에 — 신혼부부 관점" }), /* @__PURE__ */ React.createElement("div", { className: "grid lg:grid-cols-2 gap-4 items-stretch" }, PUBLIC_TYPES.map((t, i) => /* @__PURE__ */ React.createElement(Card, { key: i, className: "h-full flex flex-col" }, /* @__PURE__ */ React.createElement("div", { className: "text-[16px] font-bold mb-2" }, t.name), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 gap-y-1.5 text-[13px] text-[#3D3D3D] mb-2" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "text-[#8A8A8A]" }, "대상 "), t.target), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "text-[#8A8A8A]" }, "가격 "), t.price), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "text-[#8A8A8A]" }, "기간 "), t.term)), /* @__PURE__ */ React.createElement("p", { className: "text-[13px] text-[#525252] leading-relaxed mb-3 flex-1" }, "💡 ", t.point), /* @__PURE__ */ React.createElement("a", { href: naverSearch(t.q), target: "_blank", rel: "noopener noreferrer", className: "mt-auto text-[13px] font-semibold underline underline-offset-4" }, "최신 조건 검색")))), /* @__PURE__ */ React.createElement("div", { className: "mt-3" }, /* @__PURE__ */ React.createElement(InfoNote, null, '소득·자산 기준과 임대료는 공고·지역마다 달라요. 관심 유형은 "실시간 공고" 세그먼트에서 지금 나온 공고를 확인하고 공고문으로 최종 판단하세요.'))), seg === "notices" && /* @__PURE__ */ React.createElement(LhNoticesSection, null), seg === "longlease" && /* @__PURE__ */ React.createElement(LongLeaseTab, null));
}
const REALTY_TERMS = [
  { cat: "계약·권리 지키기", items: [
...
function RealtyTheme({ mapKey, hh, setHh, setTheme, privacy }) {
  ...
  const tab = tabRaw === "longlease" ? "public" : tabRaw;
  ...
  })), /* @__PURE__ */ React.createElement("div", { className: "mt-3" }, /* @__PURE__ */ React.createElement(InfoNote, null, "월 상환액은 이자 계산기 조건(대출 ", manWon(loanAmountCalc), " · ", loanYearsCalc, '년 · 원리금균등) 기준이에요. "적용"을 누르면 해당 은행 평균 금리로 계산기가 바뀝니다. "최신 정보로 갱신"은 금감원 공시(또는 웹 리서치) 기준 — 실제 금리는 우대조건·시점에 따라 달라요. LTV는 전 은행 공통(규제지역 40%, 생애최초 70%) + 가격구간 하드캡.'))), tab === "news" && /* @__PURE__ */ React.createElement("div", { className: "lg:grid lg:grid-cols-2 lg:gap-6 lg:items-start space-y-8 lg:space-y-0" }, /* @__PURE__ */ React.createElement(NewsPanel, { query: "부동산 규제 대출", eyebrow: "실시간 핫이슈", title: "부동산 뉴스" }), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-1.5 mb-4" }, ["과천", "서울", "경기", "성남", "안양", "수원", "전국"].map((r) => /* @__PURE__ */ React.createElement("button", { key: r, onClick: () => setNewsRegion(r), className: `h-8 px-3.5 rounded-full text-[12px] font-semibold transition-colors ${newsRegion === r ? "bg-[#0A0A0A] text-white" : "bg-white text-[#525252] shadow-sm hover:bg-[#FAFAFA]"}` }, r))), /* @__PURE__ */ React.createElement(NewsPanel, { query: `${newsRegion === "전국" ? "" : newsRegion + " "}청약 분양`, eyebrow: "지역별 청약 소식", title: `${newsRegion} 청약 뉴스` }))), tab === "cheongyak" && /* @__PURE__ */ React.createElement(CheongyakTab, { mapKey }), tab === "public" && /* @__PURE__ */ React.createElement(PublicHousingTab, null), tab === "guide" && /* @__PURE__ */ React.createElement(RealtyGuideTab, null), tab === "realty" && /* @__PURE__ */ React.createElement(RealtyListTab, { mapKey }), /* @__PURE__ */ React.createElement("div", { className: "masonry" }, /* @__PURE__ */ React.createElement(CustomNotes, { themeId: "realty", accent: "#0A0A0A" })));
}
const SAVING_TABS = [
  { id: "overview", label: "요약", icon: "grid" },
