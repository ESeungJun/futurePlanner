...
function DeniedScreen({ user }) {
  return /* @__PURE__ */ React.createElement(AuthShell, null, /* @__PURE__ */ React.createElement("div", { className: "w-12 h-12 rounded-full bg-[#F0F0F0] flex items-center justify-center mx-auto mb-4" }, /* @__PURE__ */ React.createElement(Icon, { name: "alert", size: 22 })), /* @__PURE__ */ React.createElement("h1", { className: "text-xl font-bold tracking-tight mb-1.5" }, "접근 권한이 없어요"), /* @__PURE__ */ React.createElement("p", { className: "text-[14px] text-[#8A8A8A] mb-1 break-all" }, user && user.email), /* @__PURE__ */ React.createElement("p", { className: "text-[13px] text-[#8A8A8A] mb-6 leading-relaxed" }, "이 계정은 허용 목록에 없습니다. 관리자에게 ", /* @__PURE__ */ React.createElement("code", { className: "font-mono text-[11px] bg-[#F5F5F5] px-1 rounded" }, "firebase-config.js"), "의 ALLOWED_EMAILS 추가를 요청하세요."), /* @__PURE__ */ React.createElement("button", { onClick: () => signOutAndWipe(), className: "w-full h-11 rounded-xl border border-[#E5E5E5] font-semibold text-[#525252]" }, "다른 계정으로 로그인"));
}
function Root() {
  const auth = useAuth();
