...
function loadRealty(force) {
  return memoLoad("realty", async () => {
    try {
      const r = await fetch(api("/api/realty"));
      if (r.ok) {
        const j = await r.json();
...
const LEDGER_INCOME_CATS = [
  ["salary", "\u{1F4BC} \uAE09\uC5EC"],
  ["bonus", "\u{1F381} \uC0C1\uC5EC\xB7\uBCF4\uB108\uC2A4"],
  ["side", "\u{1F4A1} \uBD80\uC218\uC785"],
  ["invest", "\u{1F4C8} \uAE08\uC735\uC218\uC785"],
  ["etcin", "\u{1F4E6} \uAE30\uD0C0\uC218\uC785"]
];
const ledgerCatLabel = (id) => (LEDGER_CATS.find((c) => c[0] === id) || LEDGER_INCOME_CATS.find((c) => c[0] === id) || ["", "\u{1F4E6} \uAE30\uD0C0"])[1];
...
function LedgerTheme({ privacy }) {
  ...
  ), /* @__PURE__ */ React.createElement(TextInput, { value: nf.memo, onChange: (v) => setNf({ ...nf, memo: v }), placeholder: "\uD56D\uBAA9\uBA85 * (\uC608: \uC6D4\uC138\xB7\uC6D4\uAE09)" }), /* @__PURE__ */ React.createElement(TextInput, { value: nf.amount, onChange: (v) => setNf({ ...nf, amount: v.replace(/[^0-9]/g, "") }), placeholder: "\uAE08\uC561(\uC6D0) *" }), /* @__PURE__ */ React.createElement(
    "select",
    {
      value: nf.cat,
