...
function CheongyakCalendar({ items, notices, onFocus }) {
  ...
  return /* @__PURE__ */ React.createElement("section", { className: "mb-6" }, /* @__PURE__ */ React.createElement(SectionHeader, { eyebrow: "한눈에 보는 일정 — 청약·무순위·LH·SH·장기전세", title: "통합 공고 캘린더" }), /* @__PURE__ */ React.createElement("div", { className: "lg:grid lg:grid-cols-5 lg:gap-6 lg:items-start" }, /* @__PURE__ */ React.createElement(Card, { className: "lg:col-span-3 mb-4 lg:mb-0" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between mb-3" }, /* @__PURE__ */ React.createElement("button", { onClick: () => moveMonth(-1), className: "w-9 h-9 rounded-lg hover:bg-[#F5F5F5] flex items-center justify-center" }, /* @__PURE__ */ React.createElement(Icon, { name: "chevron", size: 16, className: "rotate-180" })), /* @__PURE__ */ React.createElement("div", { className: "text-[16px] font-bold", style: { fontVariantNumeric: "tabular-nums" } }, cur.y, "년 ", cur.m + 1, "월 ", /* @__PURE__ */ React.createElement("span", { className: "text-[12px] font-semibold text-[#8A8A8A]" }, "일정 ", monthCnt, "건")), /* @__PURE__ */ React.createElement("button", { onClick: () => moveMonth(1), className: "w-9 h-9 rounded-lg hover:bg-[#F5F5F5] flex items-center justify-center" }, /* @__PURE__ */ React.createElement(Icon, { name: "chevron", size: 16 }))), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-1.5 mb-2" }, Object.entries(CAL_SRC).map(([v, s]) => /* @__PURE__ */ React.createElement(
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { className: "flex flex-col gap-0.5 w-full" }, evs.slice(0, 2).map((e, i) => /* @__PURE__ */ React.createElement("span", { key: i, className: `w-full truncate rounded px-0.5 text-[9px] font-bold leading-4 ${calEvCls(e)}` }, e.i.name.slice(0, 6))), evs.length > 2 && /* @__PURE__ */ React.createElement("span", { className: "text-[9px] font-bold text-[#8A8A8A]" }, "+", evs.length - 2))
    );
  })), /* @__PURE__ */ React.createElement("p", { className: "mt-3 text-[12px] text-[#8A8A8A]" }, "달력 배지의 ", /* @__PURE__ */ React.createElement("b", null, "색은 출처"), "(검정 청약 · 주황 무순위 · 초록 LH · 파랑 SH · 청록 전세), ", /* @__PURE__ */ React.createElement("b", null, "칠해진 배지는 접수시작 · 테두리는 접수마감 · 연한색은 발표·게시"), "예요. 청약·무순위는 위 지역·유형 필터가 그대로 적용되고, LH·SH·장기전세는 수도권 공고만 표시돼요.")), /* @__PURE__ */ React.createElement(Card, { className: "lg:col-span-2" }, /* @__PURE__ */ React.createElement("h4", { className: "text-[15px] font-bold mb-3", style: { fontVariantNumeric: "tabular-nums" } }, Number(selD.slice(5, 7)), "월 ", Number(selD.slice(8, 10)), "일 일정 ", /* @__PURE__ */ React.createElement("span", { className: "text-[12px] font-semibold text-[#8A8A8A]" }, dayEvents.length, "건")), dayEvents.length === 0 && /* @__PURE__ */ React.createElement("div", { className: "text-[13px] text-[#8A8A8A] py-4 text-center" }, "이 날의 공고 일정이 없어요 — 배지가 있는 날짜를 눌러보세요."), /* @__PURE__ */ React.createElement("ul", { className: "space-y-3" }, dayEvents.map((e, i) => {
    const [srcLabel, srcCls] = calSrcBadge(e);
    const isCheongyak = e.src === "apt" || e.src === "remndr";
    return /* @__PURE__ */ React.createElement("li", { key: i, className: "rounded-xl bg-[#FAFAFA] px-3.5 py-3" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 mb-1 flex-wrap" }, /* @__PURE__ */ React.createElement("span", { className: `text-[10px] font-bold px-2 py-0.5 rounded-full ${CAL_KIND[e.kind]}` }, e.kind), /* @__PURE__ */ React.createElement("span", { className: `text-[10px] font-bold px-2 py-0.5 rounded-full ${srcCls}` }, srcLabel), /* @__PURE__ */ React.createElement("span", { className: "text-[12px] text-[#8A8A8A]" }, e.i.region, !isCheongyak && e.i.type ? ` · ${e.i.type}` : "")), /* @__PURE__ */ React.createElement("div", { className: "text-[14px] font-bold leading-snug mb-1.5" }, e.i.name), /* @__PURE__ */ React.createElement("div", { className: "flex gap-3" }, isCheongyak ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("a", { href: safeUrl(e.i.url) || "https://www.applyhome.co.kr", target: "_blank", rel: "noopener noreferrer", className: "text-[12px] font-semibold underline underline-offset-4" }, "청약홈에서 확인"), /* @__PURE__ */ React.createElement("button", { onClick: () => onFocus && onFocus(e.i), className: "text-[12px] font-semibold text-[#8A8A8A] underline underline-offset-4" }, "지도에서 보기")) : safeUrl(e.i.url) && /* @__PURE__ */ React.createElement("a", { href: safeUrl(e.i.url), target: "_blank", rel: "noopener noreferrer", className: "text-[12px] font-semibold underline underline-offset-4" }, "공고 보기")));
  })))));
}
...
function LhShCalendar({ items }) {
  ...
  const events = [];
  (items || []).forEach((i) => {
    const p = normYmdStr(i.postedAt), c = normYmdStr(i.closeAt);
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "lg:grid lg:grid-cols-5 lg:gap-6 lg:items-start" }, /* @__PURE__ */ React.createElement(Card, { className: "lg:col-span-3 mb-4 lg:mb-0" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between mb-3" }, /* @__PURE__ */ React.createElement("button", { onClick: () => moveMonth(-1), className: "w-9 h-9 rounded-lg hover:bg-[#F5F5F5] flex items-center justify-center" }, /* @__PURE__ */ React.createElement(Icon, { name: "chevron", size: 16, className: "rotate-180" })), /* @__PURE__ */ React.createElement("div", { className: "text-[16px] font-bold", style: { fontVariantNumeric: "tabular-nums" } }, cur.y, "년 ", cur.m + 1, "월 ", /* @__PURE__ */ React.createElement("span", { className: "text-[12px] font-semibold text-[#8A8A8A]" }, "일정 ", monthCnt, "건")), /* @__PURE__ */ React.createElement("button", { onClick: () => moveMonth(1), className: "w-9 h-9 rounded-lg hover:bg-[#F5F5F5] flex items-center justify-center" }, /* @__PURE__ */ React.createElement(Icon, { name: "chevron", size: 16 }))), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 mb-2 flex-wrap text-[11px] font-semibold text-[#8A8A8A]" }, Object.keys(AGENCY_SOLID).map((a) => /* @__PURE__ */ React.createElement("span", { key: a, className: `px-2 py-0.5 rounded-full ${agencyBadgeCls(a)}` }, a)), /* @__PURE__ */ React.createElement("span", null, "진한색=접수마감 · 연한색=공고 게시")), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-7 text-center text-[11px] font-semibold text-[#8A8A8A] mb-1.5" }, ["일", "월", "화", "수", "목", "금", "토"].map((d, i) => /* @__PURE__ */ React.createElement("div", { key: d, className: i === 0 ? "text-[#C96A6A]" : "" }, d))), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-7 gap-1" }, Array.from({ length: firstDow }).map((_, i) => /* @__PURE__ */ React.createElement("div", { key: "e" + i })), Array.from({ length: dim }).map((_, idx) => {
    const d = idx + 1, key = ymd(cur.y, cur.m, d), evs = byDate[key] || [], sel = selD === key;
    return /* @__PURE__ */ React.createElement(
      "button",
      {
      ...
      /* @__PURE__ */ React.createElement("span", { className: `text-[12px] font-semibold ${new Date(cur.y, cur.m, d).getDay() === 0 ? "text-[#C96A6A]" : ""}` }, d),
      /* @__PURE__ */ React.createElement("div", { className: "flex flex-col gap-0.5 w-full" }, evs.slice(0, 2).map((e, i) => /* @__PURE__ */ React.createElement("span", { key: i, className: `w-full truncate rounded px-0.5 text-[9px] font-bold leading-4 ${lhshEvCls(e)}` }, e.i.name.slice(0, 6))), evs.length > 2 && /* @__PURE__ */ React.createElement("span", { className: "text-[9px] font-bold text-[#8A8A8A]" }, "+", evs.length - 2))
    );
  })), /* @__PURE__ */ React.createElement("p", { className: "mt-3 text-[12px] text-[#8A8A8A]" }, "위 기관·유형·지역·마감 필터가 캘린더에도 그대로 적용돼요. SH 공고는 마감일이 목록에 없어 게시일만 표시됩니다.")), /* @__PURE__ */ React.createElement(Card, { className: "lg:col-span-2" }, /* @__PURE__ */ React.createElement("h4", { className: "text-[15px] font-bold mb-3", style: { fontVariantNumeric: "tabular-nums" } }, Number(selD.slice(5, 7)), "월 ", Number(selD.slice(8, 10)), "일 일정 ", /* @__PURE__ */ React.createElement("span", { className: "text-[12px] font-semibold text-[#8A8A8A]" }, dayEvents.length, "건")), dayEvents.length === 0 && /* @__PURE__ */ React.createElement("div", { className: "text-[13px] text-[#8A8A8A] py-4 text-center" }, "이 날의 공고 일정이 없어요 — 배지가 있는 날짜를 눌러보세요."), /* @__PURE__ */ React.createElement("ul", { className: "space-y-3" }, dayEvents.map((e, i) => /* @__PURE__ */ React.createElement("li", { key: i, className: "rounded-xl bg-[#FAFAFA] px-3.5 py-3" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 mb-1 flex-wrap" }, /* @__PURE__ */ React.createElement("span", { className: `text-[10px] font-bold px-2 py-0.5 rounded-full ${LHSH_CAL_KIND[e.kind]}` }, e.kind), e.i.agency && /* @__PURE__ */ React.createElement("span", { className: `text-[10px] font-bold px-2 py-0.5 rounded-full ${agencyBadgeCls(e.i.agency)}` }, e.i.agency), /* @__PURE__ */ React.createElement("span", { className: "text-[12px] text-[#8A8A8A]" }, e.i.region, e.i.type ? ` · ${e.i.type}` : "")), /* @__PURE__ */ React.createElement("div", { className: "text-[14px] font-bold leading-snug mb-1.5" }, e.i.name), safeUrl(e.i.url) && /* @__PURE__ */ React.createElement("a", { href: safeUrl(e.i.url), target: "_blank", rel: "noopener noreferrer", className: "text-[12px] font-semibold underline underline-offset-4" }, "공고 보기"))))));
}
function LhNoticesSection() {
  ...
  const today = todayYmd();
  const recentCut = todayYmd(new Date(Date.now() - 45 * 864e5));
  const isOpen = (i) => {
  ...
  const filtered = state.items.filter((i) => (ft.agency === "all" || i.agency === ft.agency) && (ft.type === "all" || i.type === ft.type) && (ft.region === "all" || i.region === ft.region) && (!ft.openOnly || isOpen(i)));
  return /* @__PURE__ */ React.createElement("section", { className: "mb-6" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-end justify-between gap-3 flex-wrap" }, /* @__PURE__ */ React.createElement(SectionHeader, { eyebrow: "LH·SH 공식 데이터", title: "실시간 분양·임대 공고" }), /* @__PURE__ */ React.createElement("div", { className: "mb-4 flex items-center gap-2" }, /* @__PURE__ */ React.createElement("div", { className: "flex rounded-full bg-white shadow-sm p-0.5" }, [["list", "☰ 목록"], ["cal", "📅 캘린더"]].map(([v, l]) => /* @__PURE__ */ React.createElement("button", { key: v, onClick: () => setView(v), className: `h-8 px-3.5 rounded-full text-[12px] font-semibold transition-colors ${view === v ? "bg-[#0A0A0A] text-white" : "text-[#525252] hover:bg-[#FAFAFA]"}` }, l))), /* @__PURE__ */ React.createElement(RefreshBtn, { onClick: () => load(true), loading: state.loading }))), state.err && /* @__PURE__ */ React.createElement(Card, { className: "mb-4" }, /* @__PURE__ */ React.createElement("div", { className: "text-[14px] text-[#525252] leading-relaxed mb-3" }, /* @__PURE__ */ React.createElement("b", null, "공고를 불러오지 못했어요"), " — ", state.err), /* @__PURE__ */ React.createElement("div", { className: "text-[13px] text-[#8A8A8A] leading-relaxed" }, "LH는 data.go.kr에서 「한국토지주택공사_분양임대공고문 조회 서비스」를 활용신청하면(기존 키 그대로) 여기서 바로 보여요. 그 전에는 아래 공식 사이트에서 확인하세요."), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-2 mt-3" }, LONGLEASE_LINKS.map(([label, url]) => /* @__PURE__ */ React.createElement("a", { key: url, href: url, target: "_blank", rel: "noopener noreferrer", className: "h-10 rounded-lg bg-[#F5F5F5] flex items-center justify-center px-2 text-center text-[12px] font-semibold text-[#525252] hover:bg-[#ECECEC]" }, label)))), !state.err && /* @__PURE__ */ React.createElement(React.Fragment, null, state.warning && /* @__PURE__ */ React.createElement(Card, { className: "mb-4" }, /* @__PURE__ */ React.createElement("div", { className: "text-[13px] text-[#8A8A8A]" }, "⚠️ ", state.warning), state.lhError === "unauthorized" && /* @__PURE__ */ React.createElement("div", { className: "text-[12px] text-[#8A8A8A] mt-1.5" }, "data.go.kr에서 「한국토지주택공사_분양임대공고문 조회 서비스」를 활용신청하면(기존 키 그대로) LH 공고도 여기에 바로 표시돼요.")), /* @__PURE__ */ React.createElement(Card, { className: "mb-4" }, /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-4" }, /* @__PURE__ */ React.createElement(Select, { label: "기관", value: ft.agency, onChange: (v) => setFt({ ...ft, agency: v }), options: agencies.map((t) => ({ value: t, label: t === "all" ? "전체" : t === "SH" ? "SH (서울)" : t })) }), /* @__PURE__ */ React.createElement(Select, { label: "유형", value: ft.type, onChange: (v) => setFt({ ...ft, type: v }), options: types.map((t) => ({ value: t, label: t === "all" ? "전체" : t })) }), /* @__PURE__ */ React.createElement(Select, { label: "지역", value: ft.region, onChange: (v) => setFt({ ...ft, region: v }), options: regions.map((t) => ({ value: t, label: t === "all" ? "전체" : t })) }), /* @__PURE__ */ React.createElement(Toggle, { label: "마감된 공고", active: ft.openOnly, onClick: () => setFt({ ...ft, openOnly: !ft.openOnly }), activeText: "숨기기", inactiveText: "모두 표시" }))), /* @__PURE__ */ React.createElement("div", { className: "text-[14px] font-semibold text-[#525252] mb-3" }, "공고 ", filtered.length, "건"), state.loading && /* @__PURE__ */ React.createElement(Card, null, /* @__PURE__ */ React.createElement("div", { className: "text-[14px] text-[#8A8A8A]" }, "LH·SH 공고를 불러오는 중…")), !state.loading && filtered.length === 0 && /* @__PURE__ */ React.createElement(Card, null, /* @__PURE__ */ React.createElement("div", { className: "text-[14px] text-[#8A8A8A]" }, "조건에 맞는 공고가 없어요.")), view === "cal" && !state.loading && filtered.length > 0 && /* @__PURE__ */ React.createElement(LhShCalendar, { items: filtered }), view === "list" && /* @__PURE__ */ React.createElement("div", { className: "space-y-3" }, filtered.slice(0, 40).map((i) => /* @__PURE__ */ React.createElement(Card, { key: i.id, className: "!py-4" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-start justify-between gap-3" }, /* @__PURE__ */ React.createElement("div", { className: "min-w-0" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 flex-wrap mb-1" }, i.agency && /* @__PURE__ */ React.createElement("span", { className: `text-[12px] px-2 py-0.5 rounded-full font-semibold ${agencyBadgeCls(i.agency)}` }, i.agency), i.type && /* @__PURE__ */ React.createElement("span", { className: "text-[12px] px-2 py-0.5 rounded-full bg-[#0A0A0A]/10 text-[#0A0A0A] font-semibold" }, i.type), i.region && /* @__PURE__ */ React.createElement("span", { className: "text-[12px] px-2 py-0.5 rounded-full bg-[#F0F0F0] text-[#525252] font-semibold" }, i.region), isOpen(i) ? /* @__PURE__ */ React.createElement(ToneBadge, { tone: normYmdStr(i.closeAt) || /접수|신청/.test(String(i.status || "")) ? "good" : "neutral" }, i.status || "접수·게시 중") : /* @__PURE__ */ React.createElement(ToneBadge, { tone: "neutral" }, i.status || "마감")), /* @__PURE__ */ React.createElement("div", { className: "text-[15px] font-bold leading-snug" }, i.name), /* @__PURE__ */ React.createElement("div", { className: "text-[12px] text-[#8A8A8A] mt-1 font-mono" }, i.postedAt, " ~ ", i.closeAt || "-")), safeUrl(i.url) && /* @__PURE__ */ React.createElement("a", { href: safeUrl(i.url), target: "_blank", rel: "noopener noreferrer", className: "shrink-0 text-[13px] font-semibold underline underline-offset-4" }, "공고 보기"))))), /* @__PURE__ */ React.createElement("div", { className: "mt-3" }, /* @__PURE__ */ React.createElement(InfoNote, null, "SH(서울주택도시공사) 공고는 게시판 목록에 접수기간이 없어 ", /* @__PURE__ */ React.createElement("b", null, "게시 45일 이내면 진행 중으로 표시"), "해요 — 실제 접수 여부·일정은 공고문에서 확인하세요. 단 ", /* @__PURE__ */ React.createElement("b", null, "청년안심주택은 서울시 포털에서 신청기간을 보강"), '해 "신청 8/11~8/13"처럼 표시되고, 민간임대 청년안심주택 공고(서울시 배지)도 함께 나옵니다. LH 공고는 공식 API의 마감일·상태를 그대로 씁니다.'))));
}
