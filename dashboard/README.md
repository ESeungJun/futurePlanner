...
- **부동산** — 진단 / 전략·혜택(+제도 뉴스) / **핫이슈(실시간 부동산 뉴스, 새로고침)** / 대출계산기 / 청약정보·매물지도(**리스트 카드 클릭 → 지도 이동**, 하단 대형 지도) / 플랜(**진단 연동 브리핑 + 체크형 타임라인 + 체크리스트**)
...
- **결혼식** — 개요·예산(D-day, 예산표) / 체크리스트(**2026 실제 후기 기반 6단계 + 단계별 후기 검색 링크 + 꿀팁**) / **인기 식장(서울 10곳, 유형 필터 + 위치·가격대 검색)** / **인기 스튜디오·드레스·메이크업(스드메 탭 3종, 리스트 관리 + 실시간 리서치)** / **박람회(다가오는 일정 + 정기 박람회)** / 신혼여행(**여행지별 추천 경로** + 후기 검색)
