...
- **부동산** — **요약(진단 연동 KPI + Next Action)** / 진단 / 전략·혜택(+제도 뉴스) / 핫이슈 / 대출계산기 / 청약정보·매물지도(**카드 클릭 → 주소 지오코딩으로 지도 이동**, 좌표 없는 청약 공고 지원) / 플랜(진단 연동 브리핑 + 체크형 타임라인)
...
- **가계부** — **달력에서 일자별 지출 기입(금액·카테고리·메모)** / **고정지출(월세·구독) 매달 자동 기입 🔁** / 월 KPI / **카테고리별 지출·최근 6개월 추이** — 저장·클라우드 동기화
