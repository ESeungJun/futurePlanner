...
- **결혼식** — 개요(D-day + **KPI 요약** + **잔금 결제 가이드: 부부 총급여·올해 사용액·공제한도로 명의·현금영수증/카드 배분 추천, 지역화폐, 결제 직전 체크리스트**) / **예산표(2025~26 후기 기반 11개 카테고리 100여 항목 — 예산·지출·메모 기록, 항목·카테고리 추가·삭제)** / 체크리스트 / **식장·스드메(통합 탭 — 식장·스튜디오·드레스·메이크업·스냅 세그먼트, 실시간 리서치 + 실존 검증 + 썸네일 자동)** / **하객 리스트(신랑·신부측 이름·관계·청모 여부)** / 박람회 / 신혼여행
