...
| 🏢 부동산 | 소득·자산 진단, DSR/LTV 대출계산기, 청약 정보 + 일정 캘린더, LH·SH·장기전세·공공주택 공고, 국토부 실거래가 지도(아파트·빌라 매매/전월세), 용어·절차 가이드 |
...
| ✨ AI 상담사 | 우하단 플로팅 채팅 — 대시보드 전체 상태(소득·목표·가계부·결혼 준비·로드맵)를 아는 부부 전담 상담(Claude, 키 없으면 Gemini 폴백). 하루 한 번 먼저 브리핑, 대화에서 나온 결론을 메모·목표·타임라인·부부 정보에 [적용]으로 반영, 합의한 원칙은 '스킬'로 저장해 다음 상담에 적용 |
